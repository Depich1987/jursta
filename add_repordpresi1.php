...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO rep_ordpresi (noordonnace_ordonnance, dateaudience_ordonnance, objet_ordonnance, demandeur_ordonnance, defendeur_ordonnance, dispositif_ordonnance, observation_ordonnance, Id_admin, date_creation, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['noordonnace_ordonnance'], "text"),
                       GetSQLValueString($_POST['dateaudience_ordonnance'], "date"),
                       GetSQLValueString($_POST['objet_ordonnance'], "text"),
                       GetSQLValueString($_POST['demandeur_ordonnance'], "text"),
                       GetSQLValueString($_POST['defendeur_ordonnance'], "text"),
          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="100%" class="Style2"><p>Le repertoire des ordonnances pr&eacute;sidentielles - Ajouter un enregistrement</p></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
              <tr>
                <td align="right" valign="top" nowrap class="Style10"><span class="Style10">N&deg; de l'ordonnance</span> : </td>
                <td><input name="noordonnace_ordonnance" type="text" id="noordonnace_ordonnancel" size="20"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Date de l'audience : </td>
                <td><input name="dateaudience_ordonnance" type="text" id="dateaudience_ordonnancel" size="15" value="<?php echo date("Y-m-d"); ?>"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Objet :</td>
                <td>                  <textarea name="objet_ordonnance" cols="40" rows="5" id="objet_ordonnance"></textarea></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Demandeur :</td>
                <td><input name="demandeur_ordonnance" type="text" id="demandeur_ordonnance" size="35"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Defendeur :</td>
                <td><input name="defendeur_ordonnance" type="text" id="defendeur_ordonnance2" size="35"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"><span class="Style10">Dispositif </span> : </td>
                <td><textarea name="dispositif_ordonnance" cols="40" rows="3" id="dispositif_ordonnance"></textarea></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Observation : </td>
                <td><textarea name="observation_ordonnance" cols="40" rows="7" id="observation_ordonnance"></textarea></td>
              </tr>
              <tr>

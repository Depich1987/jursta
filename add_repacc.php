...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO rep_actesacc (nodordre_acc, date_acc, nomparties_acc, designationacte_acc, Id_admin, date_creation, id_categorieaffaire, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['nodordre_acc'], "text"),
                       GetSQLValueString(changedatefrus($_POST['date_acc']), "date"),
                       GetSQLValueString($_POST['nomparties_acc'], "text"),
                       GetSQLValueString($_POST['designationacte_acc'], "text"),
                       GetSQLValueString($_POST['id_admin'], "int"),
                       GetSQLValueString($_POST['date_creation'], "date"),
                       GetSQLValueString($_POST['id_categorieaffaire'], "texte"),
          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="100%" class="Style2"><p> Attestation de la chambre civile - Ajouter un enregistrement</p></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
              <tr>
                ...
                <td>                  <input name="nodordre_acc" type="text" id="nodordre_acc" size="20"></td>
              </tr>
              <tr>
...
?>
              ...
              <tr>
                ...
                <td><input name="date_acc" type="text" id="datepicker1" size="15" value="<?php echo date("d/m/Y"); ?>"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Nom des parties:</td>
                <td><textarea name="nomparties_acc" cols="35" rows="2" id="nomparties_acc"></textarea></td>
              </tr>
              <tr>
                ...
                <td><select name="designationacte_acc" size="1" id="designationacte_acc">
                  <option value="Attestation du plumitif" selected>Attestation du plumitif</option>
                  <option value="Certificat de Radiation">Certificat de Radiation</option>
                </select></td>
              </tr>
              <tr>

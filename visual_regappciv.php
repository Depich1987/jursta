...
$query_select_regappel = sprintf("SELECT * FROM  reg_socialappel, role_general, rep_jugementsupp WHERE ((id_socialappel = %s) AND (role_general.no_rolegeneral=rep_jugementsupp.no_rolegeneral) AND (rep_jugementsupp.no_repjugementsupp=reg_socialappel.no_repjugementsupp))", GetSQLValueString($colname_select_regappel, "int"));
        ...
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="2">
              ...
              <tr bgcolor="#FFFFFF">
                ...
                <td colspan="2" class="Style10"><?php echo $row_select_regappel['demandeur_rolegeneral']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="middle" nowrap bgcolor="#FFFFFF" class="Style10"><span class="Style10">Defendeur : </span></td>
                <td colspan="2" class="Style10"><?php echo $row_select_regappel['defendeur_rolegeneral']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
              ...
              <tr bgcolor="#FFFFFF">
                ...
                <td width="0" class="Style10"><?php echo Change_formatDate(substr($row_select_regappel['date_creation'],0,10)); ?> <br> à : <?php echo substr($row_select_regappel['date_creation'],11,8); ?></td>
                <td width="0" nowrap bgcolor="#FF0000" class="Style10"><?php echo Change_formatDate(substr($row_select_regappel['date_modif'],0,10)); ?> <br> à : <?php echo substr($row_select_regappel['date_modif'],11,8); ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">

...
if ((isset($_GET['noregpl'])) && ($_GET['noregpl'] != "")) {
  $deleteSQL = sprintf("DELETE FROM reg_plaintes_desc ,reg_plaintes_noms  WHERE reg_plaintes_desc.no_regplaintes=%s AND reg_plaintes_desc.cles_pivot = reg_plaintes_noms.cles_pivot", GetSQLValueString($_GET['noregpl'], "int"));
...
mysql_select_db($database_jursta, $jursta);
$query_liste_plainte = "SELECT * FROM reg_plaintes_desc d, reg_plaintes_noms n WHERE ((d.id_juridiction =".$row_select_juridic['id_juridiction'].") AND (d.cles_pivot = n.cles_pivot) AND ((d.nodordre_plaintes LIKE '".$_GET['wrdkey']."%') OR (n.NomPreDomInculpes_plaintes LIKE '".$_GET['wrdkey']."%'))) GROUP BY n.cles_pivot ORDER BY d.date_creation ASC";
$liste_plainte = mysql_query($query_liste_plainte, $jursta) or die(mysql_error());
$row_liste_plainte = mysql_fetch_assoc($liste_plainte);
$totalRows_liste_plainte = mysql_num_rows($liste_plainte);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <?php if ($totalRows_liste_plainte > 0) { // Show if recordset not empty ?>
                  <tr>
                        ...
                        <tr>
                          <td bgcolor="#6186AF"><table width="100%" border="0" cellpadding="3" cellspacing="1">
                              <tr bgcolor="#677787" class="Style3">
                                ...
                                <td align="center">Num&eacute;ro et date du  PV de la plainte</td>
                                <td align="center">Date d'entr&eacute;e au parquet </td>
                                <td align="center">Nom et  pr&eacute;noms des Pr&eacute;venus</td>
                                <td>Date, lieu et Nature  de l'infraction</td>
...
<?php                              
mysql_select_db($database_jursta, $jursta);
$query_listenomplainte_plainte = "SELECT * FROM reg_plaintes_noms WHERE cles_pivot = '".$row_liste_plainte['cles_pivot']."'";
...
<td align="center" valign="middle"><strong><?php echo $i ?></strong></td>
                                <td align="center" valign="middle"><strong><?php echo $row_liste_plainte['nodordre_plaintes']; ?></strong></td>
                                <td align="center" valign="middle"><strong><?php echo $row_liste_plainte['Pautosaisi_plaintes']; ?></strong></td>
                                <td align="center" valign="middle"><strong>N&deg;: <?php echo $row_liste_plaintes['PVnum_plaintes']; ?><br />
du : <?php echo Change_formatDate($row_liste_plaintes['PVdat_plaintes']); ?><span class="Style22"><br>
                          </span></strong></td>
                                <td valign="middle"><strong><?php echo Change_formatDate($row_liste_plaintes['dateparquet_plaintes']); ?></strong></td>
                                <td valign="middle"><table width="100%" border="0" cellspacing="1" cellpadding="3">
                                  <?php do { ?>
                                  <tr>
                                ...
                                <td valign="middle"><strong>le <?php echo Change_formatDate($row_liste_plainte['DatInfraction_plaintes']); ?><br>
                                &agrave; <?php echo $row_liste_plainte['LieuInfraction_plaintes']; ?><br /><?php echo $row_liste_plainte['NatInfraction_plaintes']; ?></strong></td>
                                <td valign="middle"><strong><?php echo $row_liste_plainte['naturesuite_plaintes']; ?></strong></td>
                                <td valign="middle"><strong><?php echo $row_liste_plainte['MotifClass_plaintes']; ?></strong></td>
                                <td valign="middle"><strong><?php echo $row_liste_plainte['observations_plaintes']; ?></strong></td>
                                <td valign="middle"><table width="72" height="33" >
                                    <tr align="center" class="Style16">
                                      <td><strong>
                                        <?php if ($row_select_admin['visualiser_admin']==1) { ?>
                                          <a href="#" onClick="javascript:ouvre_popup('visual_regplaintes.php?noregpl=<?php echo $row_liste_plainte['no_regplaintes']; ?>',670,560)"><img src="images/mark_f2.png" title="Visualiser" width="28" border="0"></a>
                                          <?php } else {?>
                                      ...
                                      <td><strong>
                                        <?php if ($row_select_admin['modifier_admin']==1) { ?>
                                          <a href="#" onClick="javascript:ouvre_popup('modif_regplaintes_page.php?noregpl=<?php echo $row_liste_plainte['no_regplaintes']; ?>',670,700)"><img src="images/rename_f2.png" title="Modifier" width="28" border="0"></a>
                                          <?php } else {?>
                              ...
                              <?php } while ($row_liste_plainte = mysql_fetch_assoc($liste_plainte)); ?>
                          </table></td>
                        </tr>
                      </table>
                        <br>
                        <table border="0" align="center" cellpadding="3" cellspacing="0" class="Style10">
                          <tr class="Style22">
                            <td><a href="<?php printf("%s?pageNum_liste_plainte=%d%s", $currentPage, max(0, $pageNum_liste_plainte - 1), $queryString_liste_plainte); ?>"><strong>&laquo; Pr&eacute;c&eacute;dent</strong></a> </td>
                            <td><a href="<?php printf("%s?pageNum_liste_plainte=%d%s", $currentPage, min($totalPages_liste_plainte, $pageNum_liste_plainte + 1), $queryString_liste_plainte); ?>"><strong>Suivant&raquo;</strong></a></td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td><strong>Page</strong></td>
                            <td><strong><?php echo $pageNum_liste_plainte+1 ?>/<?php echo $totalPages_liste_plainte+1; ?></strong></td>
                            <td>&nbsp;</td>
                            <td><strong>Enrg de <?php echo $startRow_liste_plainte+1; ?> &agrave; 30 </strong></td>
                            <td><strong>Total </strong></td>
                            <td><strong><?php echo $totalRows_liste_plainte ?> </strong></td>
                          </tr>
                      </table></td>
                  </tr>
                  <?php } // Show if recordset not empty ?>
                  <?php if ($totalRows_liste_plainte == 0) { // Show if recordset empty ?>
                  <tr>
...
mysql_free_result($liste_plainte);
?>

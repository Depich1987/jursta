...
$colname_select_organisation = "-1";
if (isset($_GET['jur'])) {
  $colname_select_organisation = $_GET['jur'];
}
mysql_select_db($database_jursta, $jursta);
$query_select_organisation = sprintf("SELECT * FROM juridiction WHERE id_juridiction = %s", GetSQLValueString($colname_select_organisation, "int"));
$select_organisation = mysql_query($query_select_organisation, $jursta) or die(mysql_error());
$row_select_organisation = mysql_fetch_assoc($select_organisation);
$totalRows_select_organisation = mysql_num_rows($select_organisation);
?>
<HTML>
<HEAD>
        ...
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
              <tr>
                ...
                <td><input name="id_juridiction" type="text" id="id_juridiction" value="<?php echo $row_select_organisation['id_juridiction']; ?>" size="11"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">D&eacute;signation : </td>
                <td><input name="lib_juridiction" type="text" id="lib_juridiction" value="<?php echo $row_select_organisation['lib_juridiction']; ?>" size="30"></td>
              </tr>
              <tr>
                ...
                <td><select name="id_commune" id="id_commune">
                  <?php
do {  
?><option value="<?php echo $row_Liste_commune['id_commune']?>"<?php if (!(strcmp($row_Liste_commune['id_commune'], $row_select_organisation['id_commune']))) {echo "selected=\"selected\"";} ?>><?php echo $row_Liste_commune['id_commune']?></option>
                  <?php
...
?>
                  ...
                  <input type="button" name="commune_cmd" id="commune_cmd" value="..."></td>
              </tr>
              <tr>
                ...
                <td><select name="id_typejuridiction" id="id_typejuridiction">
                  <?php
do {  
?><option value="<?php echo $row_Liste_typejuridiction['id_typejuridiction']?>"<?php if (!(strcmp($row_Liste_typejuridiction['id_typejuridiction'], $row_select_organisation['id_typejuridiction']))) {echo "selected=\"selected\"";} ?>><?php echo $row_Liste_typejuridiction['lib_typejuridiction']?></option>
                  <?php
...
?>
                  ...
                  <input type="submit" name="typejuridiction_cmd" id="typejuridiction_cmd" value="..."></td>
              </tr>
              <tr>
                ...
                <td><select name="id_juridictionTU" id="id_juridictionTU">
                  <?php
do {  
?><option value="<?php echo $row_Liste_juridiction['id_juridiction']?>"<?php if (!(strcmp($row_Liste_juridiction['id_juridiction'], $row_select_organisation['id_juridictionTU']))) {echo "selected=\"selected\"";} ?>><?php echo $row_Liste_juridiction['lib_juridiction']?></option>
                  <?php
...
<label></label></td>
              ...
              <tr>
                ...
                <td><input name="T05_ANNEE" type="text" id="T05_ANNEE" value="<?php echo $row_select_organisation['T05_ANNEE']; ?>" size="15"></td>
              </tr>
              <tr>
...
mysql_free_result($select_organisation);
?>

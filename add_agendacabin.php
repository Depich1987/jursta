...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO agenda_regcabin (date_agenda, nodossier_agenda, nomprenom_agenda, heure_agenda, Id_admin, date_creation, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString(changedatefrus($_POST['date_agenda']), "date"),
                       GetSQLValueString($_POST['nodossier_agenda'], "text"),
                       GetSQLValueString($_POST['nomprenom_agenda'], "text"),
                       GetSQLValueString($_POST['heure_agenda'], "date"),
          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="100%" class="Style2"><p>Agenda du Cabinet d'Instruction - Ajouter un enregistrement</p></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
              <tr>
                ...
                <td><input name="date_agenda" type="text" id="datepicker" size="15"></td>
                </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">N&deg; du Dossier :</td>
                <td><input name="nodossier_agenda" type="text" id="nodossier_agenda" value="" size="15"></td>
                </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"><span class="Style10">Nom et pr&eacute;noms</span> :</td>
                <td>                  <textarea name="nomprenom_agenda" cols="40" rows="5" id="nomprenom_agenda"></textarea></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"><span class="Style10">Heure</span> :</td>
                <td><input name="heure_agenda" type="text" id="heure_agenda" value="<?php echo date("H:i:s"); ?>" size="13"></td>
              </tr>
              <tr>

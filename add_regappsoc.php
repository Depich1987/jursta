...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO reg_socialappel (no_socialappel, datejour, datejugement, Signature, no_decision, Id_admin, date_creation, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['no_socialappel'], "text"),
                       GetSQLValueString($_POST['datejour'], "date"),
                       GetSQLValueString($_POST['datejugement'], "date"),
    ...
    <td align="center" bgcolor="#6186AF"><table width="100%" border="0" cellpadding="2" cellspacing="2">
      ...
      <tr>
        <td valign="middle"><table border="0" cellpadding="5" cellspacing="0">
          <tr>
            <td align="right" valign="top" nowrap class="Style10"><form name="form1" method="post" action="add_regappsoc.php">
              ...
              <form action="<?php echo $editFormAction; ?>" name="form2" method="POST">
                <table width="100%" border="0" cellpadding="5" cellspacing="0">
                  <tr class="Style10">
                    ...
                    <td width="69%" colspan="2"><input name="no_socialappel" type="text" id="no_socialappel" size="15"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="top" nowrap class="Style10">Date du 
                      jugement :</td>
                    <td colspan="2"><input name="datejugement" type="text" id="datepicker1" value="<?php echo Change_formatDate($row_select_nodossier['dateaudience_rgsocial']); ?>" size="15"></td>
                  </tr>
                  <tr>

...
if (isset($_GET['idros'])) {
  $colname_select_regopposition = $_GET['idros'];
}
mysql_select_db($database_jursta, $jursta);
$query_select_regopposition = sprintf("SELECT * FROM rep_decision, rg_social, reg_socialopposition WHERE ((id_socialopp = %s) AND (rg_social.no_rgsocial=rep_decision.no_rgsocial) AND (rep_decision.no_decision=reg_socialopposition.no_decision))", GetSQLValueString($colname_select_regopposition, "int"));
        ...
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="2">
              <tr bgcolor="#FFFFFF">
                ...
                <td colspan="2" class="Style10"><?php echo $row_select_regopposition['noordre_socialopp']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
              ...
              <tr bgcolor="#FFFFFF">
                ...
                <td colspan="2" class="Style10"><?php echo $row_select_regopposition['demandeur_rgsocial']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="middle" nowrap bgcolor="#FFFFFF" class="Style10"><span class="Style10">Defendeur : </span></td>
                <td colspan="2" class="Style10"><?php echo $row_select_regopposition['defendeur_rgsocial']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
              ...
              <tr bgcolor="#FFFFFF">
                ...
                <td width="0" class="Style10"><?php echo Change_formatDate(substr($row_select_regopposition['date_creation'],0,10)); ?> à : <?php echo substr($row_select_regopposition['date_creation'],11,8); ?></td>
                <td width="0" nowrap bgcolor="#FF0000" class="Style10"><?php echo Change_formatDate(substr($row_select_regopposition['date_modif'],0,10)); ?> à : <?php echo substr($row_select_regopposition['date_modif'],11,8); ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">

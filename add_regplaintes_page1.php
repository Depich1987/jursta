...
$idjuridiction = $_POST['id_juridiction'];
  ...
  $insertSQL = sprintf("INSERT INTO reg_plaintes_desc (nodordre_plaintes, Pautosaisi_plaintes, Red_plaintes, dateparquet_plaintes, suite_plaintes, MotifClass_plaintes, observations_plaintes, Id_admin, date_creation, DatInfraction_plaintes, LieuInfraction_plaintes, id_categorieaffaire, PVdat_plaintes,PVnum_plaintes, naturesuite_plaintes, typepv_plaintes, naturecrimes_plaintes, procedureautreparquet_plaintes, typesaisine_plaintes, id_juridiction, cles_pivot) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
					   ...
					   GetSQLValueString($_POST['PVnum_plaintes'], "text"),
...
if ((isset($_POST["MM_insert_noms"])) && ($_POST["MM_insert_noms"] == "form1")  ) {
	...
	$insertSQL = sprintf("INSERT INTO reg_plaintes_noms  (NomPreDomInculpes_plaintes, Domicile, age, NatInfraction_plaintes, text_applicable, cles_pivot, Id_admin, id_juridiction) 
					   ...
					   GetSQLValueString($_POST['text_applicable'], "text"),
					   GetSQLValueString($cles_pivot, "text"),
...
<form action="<?php echo $editFormAction; ?>" name="form1" method="POST">
  ...
  <input type="radio" name="Pautosaisi_plaintes" value="Douanes" onClick="cacher('typesaisine');">
              ...
              <tr>
                <td align="right" valign="middle" class="Style10"><span class="Style10">Redacteur du P.V </span>: </td>
...
?>
              ...
              <tr>
                ...
                <td><input name="DatInfraction_plaintes" type="text" id="datepicker1" size="15"></td>
              </tr>
              <tr>
      ...
      Non</td>
              ...
              <tr>
                ...
                <td><select name="naturesuite_plaintes" id="naturesuite_plaintes">
                  ...
                  <option value="Flagrant d&eacute;lit">Flagrant d&eacute;lit</option>
                  <option value="Citation directe">Citation directe</option>
                  <option value="Classement sans suite">Classement sans suite</option>
                </select></td>
              </tr>
              <tr>
...
<option value="Juge d'intruction">Juge d'intruction</option>
                  ...
                  <option value="Tribunal des flagrants d&eacute;lits">Tribunal des flagrants d&eacute;lits</option>
                  </select></td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="right" valign="middle" class="Style10"><input name="id_juridiction" id="id_juridiction"  value="<?php echo $row_select_admin['id_juridiction']; ?>">
        ...
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
              ...
              <tr style="display:none">
                <td align="right" valign="top" nowrap class="Style10">Texte applicable :</td>
                <td><span class="Style10">
                  <textarea name="text_applicable" id="text_applicable" cols="38" rows="3"></textarea>
                </span></td>
              </tr>
              <tr valign="middle">
                <td colspan="2" align="right" class="Style10"><div id="naturecrime" style="visibility:hidden; display:none">

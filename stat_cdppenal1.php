              ...
              <td width="100%" valign="middle" >
                <table width="100%" >
                  <tr>
                    ...
                    <td width="100%"><span class="Style2">FICHE STATISTIQUE DES CONDAMNATIONS APRES DETENTIONS PROVISOIRES PERIODE DE
<?php if ((isset($_POST['mois'])) && (isset($_POST['annee']))) echo("PERIODE DE ".$_POST['mois']."/".$_POST['annee']) ?>
            ...
            <tr>
              <td align="center" valign="middle" ><form name="form1" method="post" action="stat_affaircivil.php">
...
?>
                      ...
                      <td nowrap><select name="id_juridiction" id="select2" onChange="document.form1.submit()">
                          <?php
do {  
?>
...
?>
                      ...
                      <td nowrap><select name="mois" id="select3">
                      ...
                      <td nowrap><select name="annee" id="select4">

...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO reg_socialappel (no_socialappel, datejour, datejugement, Signature, no_repjugementsupp, Id_admin, date_creation, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
...
mysql_select_db($database_jursta, $jursta);
$query_select_nodossier = sprintf("SELECT * FROM role_general, rep_jugementsupp WHERE ((noordre_rolegeneral = %s) AND (role_general.no_rolegeneral=rep_jugementsupp.no_rolegeneral))", GetSQLValueString($colname_select_nodossier, "text"));
...
rechargerpage("liste_regappelcivil.php");
</script>
<?php
}
?>
      ...
      <tr>
        <td width="100%" valign="middle" ><table width="100%" >
          <tr bgcolor="#FFFFFF">
            ...
            <td width="100%" class="Style2"><p>Registre des Voies de Recours en Appel   - Ajouter un enregistrement</p></td>
          </tr>
        </table></td>
      </tr>
      <tr>
        <td valign="middle"><table border="0" cellpadding="5" cellspacing="0">
          <tr>
            <td align="center" valign="top" nowrap class="Style10"><form name="form1" method="post" action="add_regappciv.php">
              <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                ...
                <tr>
                  ...
                  <td colspan="2"><input name="demandeur_rolegeneral" type="text" disabled id="demandeur_rolegeneral" value="<?php echo $row_select_nodossier['demandeur_rolegeneral']; ?>" size="35"></td>
                </tr>
                <tr>
                  <td align="right" valign="top" nowrap class="Style10">Defendeur :</td>
                  <td colspan="2"><input name="defendeur_rolegeneral" type="text" disabled id="defendeur_rolegeneral" value="<?php echo $row_select_nodossier['defendeur_rolegeneral']; ?>" size="35"></td>
                </tr>
            ...
            <td width="100%" align="right" valign="top" nowrap class="Style10"><?php if ($totalRows_select_nodossier > 0) { // Show if recordset not empty ?>
              <form action="<?php echo $editFormAction; ?>" name="form2" method="POST">
                <table width="100%" border="0" cellpadding="5" cellspacing="0">
                  <tr class="Style10">
                    <td width="26%" align="right" valign="top" nowrap class="Style10">N&deg; d'Ordre : </td>
                    <td width="74%" colspan="2"><input name="no_socialappel" type="text" id="no_socialappel" size="15"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="top" nowrap class="Style10">Date du 
                      jugement :</td>
                    <td colspan="2"><input name="datejugement" type="text" id="datepicker1" value="<?php echo Change_formatDate($row_select_nodossier['dateaudience_rolegeneral']); ?>" size="15"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td nowrap><input name="id_admin" type="hidden" id="id_admin" value="<?php echo $row_select_admin['Id_admin']; ?>">
                      ...
                      <input name="no_repjugementsupp" type="hidden" id="no_repjugementsupp" value="<?php echo $row_select_nodossier['no_repjugementsupp']; ?>">

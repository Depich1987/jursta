...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO t30_fs (T30_DATE,annee, T30_MOIS, T30_NBCHAMBRE, T30_NBCHBSPEFAMILLE, T30_NBCHBSPETRAV, T30_NOMSOURCE, T30_SOURCECONTACT, T30_NBJI) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",

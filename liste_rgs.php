...
mysql_select_db($database_jursta, $jursta);
$query_liste_rgsocial = "SELECT * FROM rg_social, categorie_affaire WHERE ((categorie_affaire.id_categorieaffaire= rg_social.id_categorieaffaire) AND (rg_social.id_juridiction =".$row_select_juridic['id_juridiction'].") AND ((rg_social.noordre_rgsocial LIKE '".$_GET['wrdkey']."%') OR (rg_social.demandeur_rgsocial LIKE '".$_GET['wrdkey']."%') OR (rg_social.defendeur_rgsocial LIKE '".$_GET['wrdkey']."%'))) ORDER BY noordre_rgsocial DESC";
...
<?php
mysql_free_result($liste_rgsocial);
?>

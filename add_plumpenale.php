...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO plum_penale (dataudience_plumpenale, presi_plumpenale, greffier_plumpenale, accesseurs_plumpenale, observ_plumpenale, id_noms, Id_admin, date_creation, no_regplaintes, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString(changedatefrus($_POST['dateaudience_plumpenale']), "date"),
...
mysql_select_db($database_jursta, $jursta);
$query_select_nodossier = sprintf("SELECT * FROM reg_plaintes_desc WHERE nodordre_plaintes = %s AND (reg_plaintes_desc.id_juridiction =".$row_select_juridic['id_juridiction'].") ", GetSQLValueString($colname_select_nodossier, "text"));
...
rechargerpage("liste_plumpenale.php");
</script>
<?php
}
?>
...
<table width="480" align="center" >
  <tr>
    <td align="center" bgcolor="#CCE3FF"><table width="100%" border="0" cellpadding="2" cellspacing="2">
        ...
        <tr>
          <td valign="middle"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
            <tr>
              <td align="center" valign="middle" nowrap class="Style10"><form name="form1" method="post" action="add_plumpenale.php">
              ...
              <td width="100%" align="right" valign="top" nowrap class="Style10"><?php if ($totalRows_select_nodossier > 0) { // Show if recordset not empty ?>
                <form action="<?php echo $editFormAction; ?>" name="form2" method="POST">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    <tr class="Style10">
                      <td colspan="3" align="center" valign="top" nowrap bgcolor="#999999" class="Style10">Nom des parties / Nature de l'infraction</td>
                    </tr>
                    <tr class="Style10">
                      <td colspan="3" align="center" valign="top" nowrap bgcolor="#FFFFFF" class="Style10"><table border="0"  bgcolor="#CCE3FF" align="center" cellpadding="2" cellspacing="1" class="Style10">
                        <?php do { ?>
                        <tr>
                          ...
                          <td><img src="images/wrapleft.png" width="5" height="19"></td>
                    ...
                    <tr class="Style10">
                      ...
                      <td colspan="2"><input name="dateaudience_plumpenale" type="text" id="datepicker" value="<?php echo date("d/m/Y"); ?>" size="15"></td>
                    </tr>
                    <tr class="Style10">
                      <td align="right" valign="top" nowrap class="Style10">Pr&eacute;sident : </td>
                      <td colspan="2"><input name="presi_plumpenale" type="text" id="presi_plumpenale" size="30"></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top" nowrap class="Style10">Accesseurs : </td>
                      <td colspan="2"><textarea name="accesseurs_plumpenale" cols="30" rows="3" id="accesseurs_plumpenale"></textarea></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top" nowrap class="Style10">Procureur :</td>
                      <td colspan="2"><input name="procureur_plumpenale" type="text" id="procureur_plumpenale" size="30"></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top" nowrap class="Style10">Greffier : </td>
                      <td colspan="2"><input name="greffier_plumpenale" type="text" id="greffier_plumpenale" size="30"></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top" nowrap class="Style10">T&eacute;moins :</td>
                      <td colspan="2"><textarea name="temoin_plumpenale2" cols="40" rows="3" id="temoin_plumpenale2"></textarea></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top" nowrap class="Style10">Observation : </td>
                      <td colspan="2"><textarea name="observ_plumpenale" cols="40" rows="7" id="observ_plumpenale"></textarea></td>
                    </tr>
                    <tr>

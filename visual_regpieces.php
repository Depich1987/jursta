        ...
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="2">
              ...
              <tr bgcolor="#FFFFFF">
                ...
                <td class="Style10"><?php echo $row_select_regpieces['Nopv']; ?>  du <?php echo Change_formatDate( $row_select_regpieces['datepv']); ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
              ...
              <tr bgcolor="#FFFFFF">
                ...
                <td class="Style10"><?php echo Change_formatDate($row_select_regpieces['daterestitution']); ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" nowrap bgcolor="#FFFFFF" class="Style10">Num&eacute;ros de la C.N.I ou C.S :</td>
                <td class="Style10"><?php echo $row_select_regpieces['nocni']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">

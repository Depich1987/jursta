...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO reg_mandat (noordre_regmandat, date_regmandat, nom_regmandat, magistra_regmandat, infraction_regmandat, Id_admin, date_creation, type_regmandat, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['noordre_regmandat'], "int"),
          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="100%" class="Style2"><p>Le registre des Mandats et Recommand&eacute;s - Ajouter un enregistrement</p></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
              <tr>
                ...
                <td><input name="noordre_regmandat" type="text" id="noordre_regmandat" size="15" value=""></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Date : </td>
                <td><input name="date_regmandat" type="text" id="datepicker" size="15" value="<?php echo date("d/m/Y"); ?>"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Nom et pr&eacute;noms : </td>
                <td> <input name="nom_regmandat" type="text" id="nom_regmandat2" value="" size="33"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Nom du Magistrat : </td>
                <td><input name="magistra_regmandat" type="text" id="magistra_regmandat2" value="" size="33"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Infraction :</td>
                <td><textarea name="infraction_regmandat" cols="35" rows="4" id="infraction_regmandat2"></textarea></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"> Type : </td>
                <td><select name="type_regmandat" id="type_regmandat">
                  <option value="Mandat de depot">Mandat de d&eacute;p&ocirc;t</option>
                  <option value="Mandat d'arret">Mandat d'arr&ecirc;t</option>
                  <option value="Mandat d'amener">Mandat d'amener</option>
                  <option value="Requisitoire d'incarceration">R&eacute;quisitoire d'incarc&eacute;ration</option>

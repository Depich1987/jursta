...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO rep_decision (nodec_decision, grefier, dispositif_decision, observation_decision, statut_decision, signature_greffier, Id_admin, date_creation, no_rgsocial, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
mysql_select_db($database_jursta, $jursta);
$query_select_nodossier = sprintf("SELECT * FROM rg_social WHERE noordre_rgsocial = %s", GetSQLValueString($colname_select_nodossier, "text"));
          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="100%" class="Style2"><p>Le r&eacute;pertoire des d&eacute;cisions - Ajouter un enregistrement</p></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tr>
              <td align="right" valign="top" nowrap bgcolor="#CCE3FF" class="Style10"><form name="form1" method="post" action="add_repdecision.php">
...
<?php if ($totalRows_select_nodossier > 0) { // Show if recordset not empty ?>
                    <tr>
                        ...
                        <td colspan="2"><input name="dateaudience_decision" type="text" disabled id="dateaudience_decision" value="<?php echo Change_formatDate($row_select_nodossier['date_rgsocial']); ?>" size="15"></td>
                    </tr>
                    <tr>
                        <td align="right" valign="top" nowrap class="Style10">Objet :</td>
                        <td colspan="2">
                        <textarea name="objet_decision" cols="40" rows="5" id="objet_decision" disabled><?php echo $row_select_nodossier['objet_rgsocial']; ?></textarea></td>
                    </tr>
                    <tr>
                        <td align="right" valign="top" nowrap class="Style10">Demandeur :</td>
                        <td colspan="2"><input name="demandeur_decision" type="text" disabled id="demandeur_decision" value="<?php echo $row_select_nodossier['demandeur_rgsocial']; ?>" size="35"></td>
                    </tr>
                    <tr>
                        <td align="right" valign="top" nowrap class="Style10">Defendeur :</td>
                        <td colspan="2"><input name="defendeur_decision" type="text" disabled id="defendeur_decision" value="<?php echo $row_select_nodossier['defendeur_rgsocial']; ?>" size="35">                        </td>
                    </tr>
            ...
            <tr>
              <td width="100%" align="right" valign="top" nowrap class="Style10"><?php if ($totalRows_select_nodossier > 0) { // Show if recordset not empty ?>
                <form action="<?php echo $editFormAction; ?>" name="form2" method="POST">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    <tr>
                      <td width="26%" align="right" valign="middle" nowrap class="Style10">N&deg; de la D&eacute;cision : </td>
                      <td width="74%" colspan="2"><input name="nodec_decision" type="text" id="nodec_decision" size="20"></td>
                    </tr>
                    <tr>
                      <td align="right" valign="middle" nowrap class="Style10">Greffier : </td>
                      <td colspan="2"><input name="grefier" type="text" id="grefier" size="30"></td>
                    </tr>
                    <tr valign="middle" class="Style10">
                      <td colspan="3" align="right" nowrap class="Style10">
                    <div id="statut" style="display:none; visibility:hidden">
                    <table width="100%" cellpadding="5" cellspacing="0">
                    <tr>
                      <td width="26%" align="right" valign="top" nowrap class="Style10"> Statut : </td>
                      <td width="74%" colspan="2"><input name="statut_decision" type="radio" value="Acceptée" checked>
Accept&eacute;e
<input type="radio" name="statut_decision" value="Rejetée">
Rejet&eacute;e</td>
                    </tr>
                    </table>
                    </div>
  					...
  					<tr>
                      <td align="right" valign="middle" nowrap class="Style10">Dispositif : </td>
                      <td colspan="2">
                        <select name="dispositif_decision" id="dispositif_decision">
                    ...
                    <tr>
                      ...
                      <td colspan="2"><textarea name="observation_decision" cols="40" rows="7" id="textarea5"></textarea></td>
                    </tr>
                                        <tr>
                      <td align="right" valign="top" nowrap class="Style10">Signature Greffier :</td>
                      <td colspan="2"><textarea name="signature_greffier" cols="40" rows="2" id="signature_greffier" disabled>Approuv&eacute;e par <?php echo $row_select_admin['nom_admin']; ?> <?php echo $row_select_admin['prenoms_admin']; ?> le : <?php echo Change_formatDate(date("Y-m-d")); ?> à : <?php echo date("H:i:s");?></textarea></td>
                    </tr>
                    <tr>

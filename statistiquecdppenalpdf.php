...
</table><iframe src="statistiquecdppenaltransforme.php" name="framestatistiques" width="100%" marginwidth="0" height="600" marginheight="0" scrolling="Auto" frameborder="0" id="framerecu" allowtransparency="1"> </iframe>
</body>
</html>
<?php

...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO rep_ordpresi (noordonnace_ordonnance, dispositif_ordonnance, observation_ordonnance, lien_fich, Id_admin, date_creation, no_rolegeneral, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
...
<table width="480" align="center" >
  <tr>
    <td align="center" bgcolor="#6186AF"><table width="100%" border="0" cellpadding="2" cellspacing="2">
        ...
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="4" cellspacing="0">
            <tr>
              <td align="right" valign="top" nowrap class="Style10"><form name="form1" method="post" action="add_repordpresi.php">
...
<?php if ($totalRows_select_nodossier > 0) { // Show if recordset not empty ?>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                        <textarea name="objet_repjugementsupp" cols="35" rows="5" id="objet_repjugementsupp" disabled><?php echo $row_select_nodossier['objet_rolegeneral']; ?></textarea></td>
                    </tr>
                    <tr>
                ...
                <form action="<?php echo $editFormAction; ?>" name="form2" method="POST">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    <tr>
                      ...
                      <td colspan="2"><input name="noordonnace_ordonnance" type="text" id="noordonnace_ordonnance" size="20"></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top" nowrap class="Style10">Dispositif : </td>
                      <td colspan="2">
                        <select name="dispositif_ordonnance" id="dispositif_ordonnance">
                    ...
                    <tr>
                      ...
                      <td colspan="2"><textarea name="observation_ordonnance" cols="35" rows="7" id="textarea5"></textarea></td>
                    </tr>
                    <tr>
                      <td align="right" valign="middle" nowrap class="Style10">Fichier :</td>
                      <td colspan="2"><input name="lien_fich" type="file"  class="Style2" id="lien_fich" size="30"></td>
                    </tr>
                    <tr>

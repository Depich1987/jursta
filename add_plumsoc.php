...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO plum_social (presi_plumsociale, greffier_plumsociale, accesseurs_plumsociale, observ_plumsociale, Id_admin, date_creation, no_rgsocial, dataudience_plumsociale, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['dateaudience_plumsociale'], "date"),
    ...
    <td align="center" bgcolor="#6186AF"><table width="100%" border="0" cellpadding="2" cellspacing="2">
      ...
      <tr>
        <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
          <tr>
            <td align="right" valign="top" nowrap class="Style10"><form name="form1" method="post" action="add_plumsoc.php">
              <table width="100%" border="0" cellpadding="5" cellspacing="0">
                ...
                <tr>
                  ...
                  <td colspan="2"><input name="dateaudience_rgsocial" type="text" disabled id="dateaudience_rgsocial" value="<?php echo Change_formatDate($row_select_nodossier['dateaudience_rgsocial']); ?>" size="15"></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="2"><textarea name="objet_rgsocial" cols="40" rows="5" id="objet_rgsocial" disabled><?php echo $row_select_nodossier['objet_rgsocial']; ?></textarea></td>
                </tr>
              ...
              <form action="<?php echo $editFormAction; ?>" name="form2" method="POST">
                <table width="100%" border="0" cellpadding="5" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td colspan="2"><textarea name="accesseurs_plumsociale" cols="30" rows="3" id="accesseurs_plumsociale"></textarea></td>
                  </tr>
                  <tr>

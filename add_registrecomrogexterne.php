      ...
      <td valign="top"><table width="100%" border="0" cellpadding="2" cellspacing="2">
        <tr>
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr>
                <td><span class="Style2"><a href="add_registrecomrogexterne.php"><img src="images/forms48.png" width="32" border="0"></a></span></td>
                <td width="100%" class="Style2"><p>Le registre des commissions rogatoires externes
                   </p>

          ...
          <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="2" cellspacing="2">
              <tr>
                <td width="100%" valign="middle" >
                  <table width="100%" >
                    <tr>
                   	<td valign="top"><span class="Style2"><a href="stat_affairsocial.php"><img src="images/forms48.png" width="32" border="0"></a></span></td>
                      <td width="100%"><div align="center">
                        ...
                        <p class="Style2">STATISTIQUE DES AFFAIRES SOCIALES 
                          <?php 
...
mysql_select_db($database_jursta, $jursta);
$query_affairesenrolees = "SELECT count(*) as affairesenrolees FROM rg_social, administrateurs WHERE ((administrateurs.Id_admin=rg_social.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.")  AND (left(replace(rg_social.date_creation,'-',''),6)='".$annee.$mois."') AND (rg_social.id_categorieaffaire=".$categorie."))";
...
mysql_select_db($database_jursta, $jursta);
$query_affairesprecedent = "SELECT count(*) as affairesprecedent FROM rg_social, administrateurs WHERE ((administrateurs.Id_admin=rg_social.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.")  AND (left(replace(rg_social.date_creation,'-',''),6)<'".$annee.$mois."') AND (rg_social.id_categorieaffaire=".$categorie."))";
...
mysql_select_db($database_jursta, $jursta);
$query_demandeaccepte = "SELECT count(*) as demandeaccepte FROM administrateurs, rep_jugementsupp, rg_social WHERE ((administrateurs.Id_admin=rep_jugementsupp.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (left(replace(rg_social.date_creation,'-',''),6)='".$annee.$mois."') AND (rg_social.id_categorieaffaire=".$categorie.") AND (rep_jugementsupp.statut_jugementsupp='Accept&eacute;e')  AND (rg_social.no_rgsocial=rep_jugementsupp.no_rgsocial))";
...
mysql_select_db($database_jursta, $jursta);
$query_demanderejete = "SELECT count(*) as demanderejete FROM administrateurs, rep_jugementsupp, rg_social WHERE ((administrateurs.Id_admin=rep_jugementsupp.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (left(replace(rg_social.date_creation,'-',''),6)='".$annee.$mois."') AND (rg_social.id_categorieaffaire=".$categorie.") AND (rep_jugementsupp.statut_jugementsupp='Rejet&eacute;e')  AND (rg_social.no_rgsocial=rep_jugementsupp.no_rgsocial))";
...
mysql_select_db($database_jursta, $jursta);
$query_jug_contradictoires = "SELECT count(*) as jugcontradictoires FROM administrateurs, rep_jugementsupp, rg_social WHERE ((administrateurs.Id_admin=rep_jugementsupp.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (left(replace(rg_social.date_creation,'-',''),6)='".$annee.$mois."') AND (rg_social.id_categorieaffaire=".$categorie.") AND (rep_jugementsupp.dispositif_repjugementsupp='Contradictoire')  AND (rg_social.no_rgsocial=rep_jugementsupp.no_rgsocial))";
...
mysql_select_db($database_jursta, $jursta);
$query_jugincompetence = "SELECT count(*) as jugincompetence FROM administrateurs, rep_jugementsupp, rg_social WHERE ((administrateurs.Id_admin=rep_jugementsupp.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (left(replace(rg_social.date_creation,'-',''),6)='".$annee.$mois."') AND (rg_social.id_categorieaffaire=".$categorie.") AND (rep_jugementsupp.dispositif_repjugementsupp='Incompetence')  AND (rg_social.no_rgsocial=rep_jugementsupp.no_rgsocial))";
...
mysql_select_db($database_jursta, $jursta);
$query_jugradiatiation = "SELECT count(*) as jugradiatiation FROM administrateurs, rep_jugementsupp, rg_social WHERE ((administrateurs.Id_admin=rep_jugementsupp.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (left(replace(rg_social.date_creation,'-',''),6)='".$annee.$mois."') AND (rg_social.id_categorieaffaire=".$categorie.") AND (rep_jugementsupp.dispositif_repjugementsupp='Radiation')  AND (rg_social.no_rgsocial=rep_jugementsupp.no_rgsocial))";
...
mysql_select_db($database_jursta, $jursta);
$query_jugdefaut = "SELECT count(*) as jugdefaut FROM administrateurs, rep_jugementsupp, rg_social WHERE ((administrateurs.Id_admin=rep_jugementsupp.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (left(replace(rg_social.date_creation,'-',''),6)='".$annee.$mois."') AND (rg_social.id_categorieaffaire=".$categorie.") AND (rep_jugementsupp.dispositif_repjugementsupp='Defaut')  AND (rg_social.no_rgsocial=rep_jugementsupp.no_rgsocial))";
...
mysql_select_db($database_jursta, $jursta);
$query_total_affairesprecedent = "SELECT count(*) as affairesprecedent FROM rg_social, administrateurs WHERE ((administrateurs.Id_admin=rg_social.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.")  AND (left(replace(rg_social.date_creation,'-',''),6)<'".$annee.$mois."'))";
...
mysql_select_db($database_jursta, $jursta);
$query_total_affairesenrolees = "SELECT count(*) as affairesenrolees FROM rg_social, administrateurs WHERE ((administrateurs.Id_admin=rg_social.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.")  AND (left(replace(rg_social.date_creation,'-',''),6)='".$annee.$mois."') )";
...
mysql_select_db($database_jursta, $jursta);
$query_total_demandeaccepte = "SELECT count(*) as demandeaccepte FROM administrateurs, rep_jugementsupp, rg_social WHERE ((administrateurs.Id_admin=rep_jugementsupp.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (left(replace(rg_social.date_creation,'-',''),6)='".$annee.$mois."') AND (rep_jugementsupp.statut_jugementsupp='Accept&eacute;e')  AND (rg_social.no_rgsocial=rep_jugementsupp.no_rgsocial))";
...
mysql_select_db($database_jursta, $jursta);
$query_total_demanderejete = "SELECT count(*) as demanderejete FROM administrateurs, rep_jugementsupp, rg_social WHERE ((administrateurs.Id_admin=rep_jugementsupp.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (left(replace(rg_social.date_creation,'-',''),6)='".$annee.$mois."') AND (rep_jugementsupp.statut_jugementsupp='Rejet&eacute;e')  AND (rg_social.no_rgsocial=rep_jugementsupp.no_rgsocial))";
...
mysql_select_db($database_jursta, $jursta);
$query_total_jugcontradictoires = "SELECT count(*) as jugcontradictoires FROM administrateurs, rep_jugementsupp, rg_social WHERE ((administrateurs.Id_admin=rep_jugementsupp.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (left(replace(rg_social.date_creation,'-',''),6)='".$annee.$mois."') AND (rep_jugementsupp.dispositif_repjugementsupp='Contradictoire')  AND (rg_social.no_rgsocial=rep_jugementsupp.no_rgsocial))";
...
mysql_select_db($database_jursta, $jursta);
$query_total_jugincompetence = "SELECT count(*) as jugincompetence FROM administrateurs, rep_jugementsupp, rg_social WHERE ((administrateurs.Id_admin=rep_jugementsupp.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (left(replace(rg_social.date_creation,'-',''),6)='".$annee.$mois."') AND (rep_jugementsupp.dispositif_repjugementsupp='Incompetence')  AND (rg_social.no_rgsocial=rep_jugementsupp.no_rgsocial))";
...
mysql_select_db($database_jursta, $jursta);
$query_total_jugradiatiation = "SELECT count(*) as jugradiatiation FROM administrateurs, rep_jugementsupp, rg_social WHERE ((administrateurs.Id_admin=rep_jugementsupp.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (left(replace(rg_social.date_creation,'-',''),6)='".$annee.$mois."')  AND (rep_jugementsupp.dispositif_repjugementsupp='Radiation')  AND (rg_social.no_rgsocial=rep_jugementsupp.no_rgsocial))";
...
mysql_select_db($database_jursta, $jursta);
$query_total_jugdefaut = "SELECT count(*) as jugdefaut FROM administrateurs, rep_jugementsupp, rg_social WHERE ((administrateurs.Id_admin=rep_jugementsupp.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (left(replace(rg_social.date_creation,'-',''),6)='".$annee.$mois."')  AND (rep_jugementsupp.dispositif_repjugementsupp='Defaut')  AND (rg_social.no_rgsocial=rep_jugementsupp.no_rgsocial))";
...
mysql_select_db($database_jursta, $jursta);
$query_total_nbactecc = "SELECT count(*) as nbactecc FROM rep_actesacc, administrateurs WHERE ((administrateurs.Id_admin=rep_actesacc.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (left(replace(rep_actesacc.date_creation,'-',''),6)='".$annee.$mois."'))";
...
mysql_free_result($total_nbactecc);
...
mysql_free_result($total_demanderejete);

mysql_free_result($total_demandeaccepte);

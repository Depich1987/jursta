...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO reg_civilopposition (noordre_civilopp, datejour, datejugdefaut, datesignification, newdataudience, signature, no_repjugementsupp, Id_admin, date_creation, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
    ...
    <td align="center" bgcolor="#6186AF"><table width="100%" border="0" cellpadding="2" cellspacing="2">
      ...
      <tr>
        <td valign="middle"><table border="0" cellpadding="5" cellspacing="0">
          <tr>
            <td align="right" valign="top" nowrap class="Style10"><form name="form1" method="post" action="add_regoppciv.php">
              ...
              <form action="<?php echo $editFormAction; ?>" name="form2" method="POST">
                <table width="100%" border="0" cellpadding="5" cellspacing="0">
                  <tr class="Style10">
                    ...
                    <td width="69%" colspan="2"><input name="noordre_civilopp" type="text" id="noordre_civilopp" size="15"></td>
                  </tr>
                  <tr>
                    <td align="right" valign="top" nowrap class="Style10">Date du 
                      jugement <br> par d&eacute;faut :</td>
                    <td colspan="2"><input name="datejugdefaut" type="text" id="datepicker" value="<?php echo Change_formatDate($row_select_nodossier['dateaudience_rolegeneral']); ?>" size="15"></td>
                  </tr>
                  <tr>

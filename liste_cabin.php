...
mysql_select_db($database_jursta, $jursta);
$query_liste_cabin = "SELECT * FROM reg_cabin, rep_jugementcorr, reg_plaintes_desc WHERE ((reg_plaintes_desc.no_regplaintes=rep_jugementcorr.no_regplaintes) AND (rep_jugementcorr.no_repjugementcorr=reg_cabin.no_repjugementcorr)AND (reg_cabin.id_juridiction =".$row_select_juridic['id_juridiction'].") AND ((reg_cabin.numodre_regcabin LIKE '".$_GET['wrdkey']."%') OR (rep_jugementcorr.nojugement_repjugementcorr LIKE '".$_GET['wrdkey']."%'))) ORDER BY id_regcabin DESC";
                                                ...
                                                <tr align="center" class="Style16">
                                                  ...
                                                  <td nowrap><strong>
                                                    <?php if ($row_select_admin['modifier_admin']==1) { ?>
                                                      <a href="#" onClick="javascript:ouvre_popup('modif_regcabin.php?idrca=<?php echo $row_liste_cabin['id_regcabin']; ?>',470,500)"><img src="images/rename_f2.png" title="Modifier" width="28" border="0"></a>
                                                      <?php } else {?>

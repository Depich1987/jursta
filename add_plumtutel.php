...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO plum_tutelle (presi_plumtutel, greffier_plumtutel, accesseurs_plumtutel, Substitut_Plumtutel, observ_plumtutel, Id_admin, date_creation, no_rolegeneral, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['substitut_plumtutel'], "text"),
...
mysql_select_db($database_jursta, $jursta);
$query_select_nodossier = sprintf("SELECT * FROM role_general WHERE noordre_rolegeneral = %s", GetSQLValueString($colname_select_nodossier, "text"));
...
rechargerpage("liste_plumtutel.php");
</script>
<?php
}
?>
          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="100%" class="Style2"><p>Plumitif de la Chambre des Tutelles  - Ajouter un enregistrement</p></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tr>
              <td align="right" valign="top" nowrap bgcolor="#CCE3FF" class="Style10"><form name="form1" method="post" action="add_plumtutel.php">
                  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                    <tr>
                      <td align="right" valign="top" nowrap class="Style10">N&deg; Dossier :</td>
                      <td><input name="noordre_rolegeneral" type="text" id="noordre_rolegeneral" value="<?php if(isset($row_select_nodossier['noordre_rolegeneral'])) {echo $row_select_nodossier['noordre_rolegeneral']; }?>" size="15"></td>
                      <td width="100%"><input type="submit" name="Afficher" value="Afficher"></td>
                    </tr>
<?php if ((isset($totalRows_select_nodossier)) &&  ($totalRows_select_nodossier == 0) && ($_POST['Afficher']!="")) { // Show if recordset empty ?>                    
                    <tr align="center">
                      <td colspan="3" valign="top" nowrap class="Style11">Aucun N&deg; de dossier ne correspond</td>
                    </tr>
<?php } ?>					
<?php if ((isset($totalRows_select_nodossier)) && $totalRows_select_nodossier > 0) { // Show if recordset not empty ?>
                    <tr>
                        <td align="right" valign="top" nowrap class="Style10">Date de l'audience : </td>
                        <td colspan="2"><strong class="Style10"><?php echo Change_formatDate($row_select_nodossier['dateaudience_rolegeneral']); ?></strong></td>
                    </tr>
                    <tr>
                        <td align="right" valign="top" nowrap class="Style10">Demandeur :</td>
                        <td colspan="2"><strong class="Style10"><?php echo $row_select_nodossier['demandeur_rolegeneral']; ?></strong></td>
                    </tr>
                    <tr>
                        <td align="right" valign="top" nowrap class="Style10">Defendeur :</td>
                        <td colspan="2"><strong class="Style10"><?php echo $row_select_nodossier['defendeur_rolegeneral']; ?></strong></td>
                    </tr>
                    <tr>
            ...
            <tr>
              <td width="100%" align="right" valign="top" nowrap class="Style10"><?php if ((isset($totalRows_select_nodossier)) &&  $totalRows_select_nodossier > 0) { // Show if recordset not empty ?>
                <form action="<?php echo $editFormAction; ?>" name="form2" method="POST">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    <tr class="Style10">
                      ...
                      <td colspan="2"><input name="presi_plumtutel" type="text" id="presi_plumtutel" size="30"></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top" nowrap class="Style10">Greffiers  :</td>
                      <td colspan="2"><input name="greffier_plumtutel" type="text" id="greffier_plumtutel" size="30"></td>
                    </tr>
                    <tr style="display:none">
                      <td align="right" valign="top" nowrap class="Style10">Assesseurs : </td>
                      <td colspan="2"><textarea name="accesseurs_plumtutel" cols="30" rows="3" id="accesseurs_plumtutel"></textarea></td>
                    </tr>
                    <tr style="display:none">
                      <td align="right" valign="top" nowrap class="Style10">Substitut du P.R :</td>
                      <td colspan="2"><input name="substitut_Plumtutel" type="text" id="substitut_plumtutel" size="30"></td>
                    </tr>
                                        
                    <tr>
                      <td align="right" valign="top" nowrap class="Style10">Observation : </td>
                      <td colspan="2"><textarea name="observ_plumtutel" cols="40" rows="7" id="observ_plumtutel"></textarea></td>
                    </tr>
                    <tr>

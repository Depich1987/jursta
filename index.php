                                            ...
                                            <table width="458" border="0" align="center" cellpadding="5" cellspacing="3">
                                              <tr>
                                                <td width="460"><p class="Style5">Pourquoi l'identification ?</p>
                                                    ...
                                                    <p align="justify" class="Style11"><img src="images/VST01058.gif" width="80" height="80" align="left">Si vous avez oubli&eacute; vos param&egrave;tres de connection veuillez contacter l'administrateur.</p>
...
<?php } ?>															  
                                                              ...
                                                              <tr>
                                                                <td colspan="2"><table width="100%"  border="0" cellpadding="0" cellspacing="3" class="Style3">
                                                                  <tr>
                                                                    <td bgcolor="#677787" class="Style11">Si vous avez oubli&eacute; vos parm&egrave;tres de connection veuillez contacter l'administrateur</td>
                                                                    </tr>
                                                                </table></td>
                                                              </tr>
                                                              <tr>

...
mysql_select_db($database_jursta, $jursta);
$query_liste_cc = "SELECT * FROM reg_cahiercharge, categorie_affaire WHERE ((categorie_affaire.id_categorieaffaire=reg_cahiercharge.id_categorieaffaire) AND (reg_cahiercharge.id_juridiction =".$row_select_juridic['id_juridiction'].")AND ((reg_cahiercharge.noordre_cc LIKE '".$_GET['wrdkey']."%') OR (reg_cahiercharge.demandeur_cc LIKE '".$_GET['wrdkey']."%') OR (reg_cahiercharge.defendeur_cc LIKE '".$_GET['wrdkey']."%'))) ORDER BY reg_cahiercharge.noordre_cc DESC";

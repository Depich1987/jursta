...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO region (id_region, id_admin, date_creation) VALUES (%s, %s, %s)",
        ...
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
              <tr>
                ...
                <td><input name="lib_departement" type="text" id="lib_departement" size="30"></td>
              </tr>
              <tr>

...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO rep_decisiontutel (nodec_dectutel, date_dectutel, lien_dectutel, decision_dectutel, observation_dectutel, signature_greffier, Id_admin, date_creation, no_rolegeneral, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="100%" class="Style2"><p>R&eacute;pertoire de la Chambre des Tutelles  - Ajouter un enregistrement</p></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tr>
              <td align="right" valign="top" nowrap bgcolor="#CCE3FF" class="Style10"><form name="form1" method="post" action="add_reptutelle.php">
                ...
                <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form2">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    <tr class="Style10">
                      ...
                      <td colspan="2"><input name="nodec_dectutel" type="text" id="nodec_dectutel" size="15"></td>
                    </tr>
                    <tr>
                      <td align="right" valign="middle" nowrap class="Style10">Date  :</td>
                      <td colspan="2"><input name="date_dectutel" type="text" id="datepicker" size="15"></td>
                    </tr>
                    <tr>
                      ...
                      <td colspan="2"><select name="decision_dectutel" id="decision_dectutel">
                        <option value="Accord">Accord / Garde juridique</option>
                        <option value="Radie">Radi&eacute;</option>
                        <option value="Rejete">Rejet&eacute;e</option>
                      </select></td>
                    </tr>
                    <tr>
                      <td align="right" valign="middle" nowrap class="Style10">Fichier :</td>
                      <td colspan="2"><input name="lien_dectutel" type="file" class="Style2" id="lien_dectutel"></td>
                    </tr>
                    <tr>
                      <td align="right" valign="middle" nowrap class="Style10">Observation :</td>
                      <td colspan="2"><textarea name="observation_dectutel" id="observation_dectutel" cols="40" rows="5"></textarea></td>
                    </tr>
                    <tr>

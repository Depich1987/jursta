...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE rep_actesnot SET noordre_repactesnot=%s, demandeur_repactesnot=%s, requerant_repactesnot=%s, natdossier_repactesnot=%s, lien_fich=%s, Id_admin=%s, date_creation=%s, id_categorieaffaire=%s WHERE no_repactesnot=%s",
                       ...
                       GetSQLValueString($_POST['no_repactesnot'], "int"));
          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="100%" class="Style2"><p>Actes de notori&eacute;t&eacute; - Modifier un enregistrement</p></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
              <tr>
                ...
                <td><input name="dateaudience_repactesnot" type="text" id="datepicker1" value="<?php echo Change_formatDate($row_select_repactenot['dateaudience_repactesnot']); ?>" size="20"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">N&deg; d'ordre : </td>
                <td><input name="noordre_repactesnot" type="text" id="noordre_repactesnot" size="15" value="<?php echo $row_select_repactenot['noordre_repactesnot']; ?>"></td>
              </tr>
              <tr>
...
do {  
?>
                  <option value="<?php echo $row_liste_nature['id_categorieaffaire']?>"<?php if (!(strcmp($row_liste_nature['id_categorieaffaire'], $row_select_repactenot['id_categorieaffaire']))) {echo "SELECTED";} ?>><?php echo $row_liste_nature['lib_categorieaffaire']?></option>
                  <?php
...
?>
              ...
              <tr>
                ...
                <td><input name="demandeur_repactesnot" type="text" id="demandeur_repactesnot" value="<?php echo $row_select_repactenot['demandeur_repactesnot']; ?>" size="35"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Requerant:</td>
                <td><input name="requerant_repactesnot" type="text" id="requerant_repactesnot" value="<?php echo $row_select_repactenot['requerant_repactesnot']; ?>" size="35"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Nature du dossier: </td>
                <td><textarea name="natdossier_repactesnot" cols="40" rows="5" id="natdossier_repactesnot"><?php echo $row_select_repactenot['natdossier_repactesnot']; ?></textarea></td>
              </tr>
              <tr>
                <td align="right" valign="middle" nowrap class="Style10">Fichier :</td>
                <td><input name="lien_fich" type="file"  value="<?php echo $row_select_repactenot['lien_fich']; ?>"class="Style2" id="lien_fich" size="30"></td>
              </tr>
              <tr>
                <td nowrap><input name="id_admin" type="hidden" id="id_admin" value="<?php echo $row_select_admin['Id_admin']; ?>">
                    ...
                    <input name="no_repactesnot" type="hidden" id="no_repactesnot" value="<?php echo $row_select_repactenot['no_repactesnot']; ?>"></td>

...
<html>
    <head>
        ...
        <title>Exemple d'auto g&eacute;n&eacute;ration de PDF</title>
    </head>
    <body>
<?php
}
...
?>
<br>
Ceci est un exemple de g&eacute;n&eacute;ration de PDF via un bouton :)<br>
<br>
...
<?php
    if ($generate) {
?>
Bonjour <b><?php echo $nom; ?></b>, ton nom peut s'&eacute;crire : <br>

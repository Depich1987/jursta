...
<page footer="form">
    ...
    <form action="<?php echo $url; ?>">
        ...
        <select name="aime[]" size="5" multiple="multiple">
            ...
            <option value="ch2">le cin&eacute;ma</option>
            <option value="ch3">le sport</option>
            <option value="ch4">la litt&eacute;rature</option>
            <option value="ch5">autre</option>
        </select><br>
        <br>
        Votre phrase f&eacute;tiche : <input type="text" name="phrase" value="cette lib est g&eacute;niale !!!" style="width: 100mm"><br>
        <br>
        Un commentaire ?<br>

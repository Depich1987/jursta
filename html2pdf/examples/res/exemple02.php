...
<page style="font-size: 10pt">
    <span style="font-size: 16pt ; font-weight: bold">D&eacute;monstration des images</span><br>
    <br>
    <b>Dans un tableau :</b><br>
    <table style="width: 50%;border: solid 3px #5544DD" align="center">
        <tr>
            <td style="width: 30%; text-align: left; ">Text &agrave; gauche<br>avec retour &agrave;<br>la ligne</td>
            <td style="width: 40%; text-align: center;"><img src="./res/logo.gif" alt="" ><br><i>l&eacute;gende</i></td>
            <td style="width: 30%; text-align: right; ">Texte &agrave; droite</td>
        </tr>
    </table>
    <br>
    Texte <span style="text-decoration: underline">soulign&eacute;</span>,
    texte <span style="text-decoration: overline">surlign&eacute;</span>,
    texte <span style="text-decoration: line-through">barr&eacute;</span>,
    texte <span style="text-decoration: underline overline line-through">avec les trois</span>.<br>
    <br>
    <b>Dans un texte :</b><br>
    texte &agrave; la suite d'une image, <img src="./res/logo.gif" alt="" style="height: 10mm">
    texte &agrave; la suite d'une image, r&eacute;p&eacute;titif car besoin d'un retour &agrave; la ligne
    texte &agrave; la suite d'une image, r&eacute;p&eacute;titif car besoin d'un retour &agrave; la ligne
    texte &agrave; la suite d'une image, r&eacute;p&eacute;titif car besoin d'un retour &agrave; la ligne
    texte &agrave; la suite d'une image, r&eacute;p&eacute;titif car besoin d'un retour &agrave; la ligne<br>
    <br>
    <br>
    Test diff&eacute;rentes tailles texte
    ...
    Test diff&eacute;rentes tailles texte, r&eacute;p&eacute;titif car besoin d'un retour &agrave; la ligne
    Test diff&eacute;rentes tailles texte, r&eacute;p&eacute;titif car besoin d'un retour &agrave; la ligne
    Test diff&eacute;rentes tailles texte, r&eacute;p&eacute;titif car besoin d'un retour &agrave; la ligne
    Test diff&eacute;rentes tailles texte, r&eacute;p&eacute;titif car besoin d'un retour &agrave; la ligne
    <br>

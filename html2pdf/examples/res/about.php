...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 12pt">
    ...
    <bookmark title="Pr&eacute;sentation" level="0" ></bookmark>
    ...
    <br><br><br><br><br>
    <div class="note">
        HTML2PDF est un convertisseur de code HTML vers PDF &eacute;crit en PHP5, utilisant la librairie <a href="http://tcpdf.org">TCPDF.</a><br>
        <br>
        Il permet la conversion d'HTML et d'xHTML valide au format PDF, et est distribu&eacute; sous licence LGPL.<br>
        <br>
        Cette librairie a &eacute;t&eacute; conçue pour g&eacute;rer principalement les TABLE imbriqu&eacute;es afin de g&eacute;n&eacute;rer des factures, bon de livraison, et autres documents officiels.<br>
        <br>
        Vous pouvez t&eacute;l&eacute;charger la derni&egrave;re version de HTML2PDF ici : <a href="http://html2pdf.fr/">http://html2pdf.fr/</a>.<br>
    </div>
</page>
<page pageset="old">
...
<page pageset="old">
    <bookmark title="Compatibilit&eacute;" level="0" ></bookmark>
    ...
    <ul class="main">
        ...
        <li>&lt;br&gt; : Permet d'aller &agrave; la ligne</li>
    ...
    <bookmark title="Balises sp&eacute;cifiques" level="2" ></bookmark>
    <div class="note">
        Les balises sp&eacute;cifiques suivantes ont &eacute;t&eacute; ajout&eacute;es :<br>
    </div>
    <br>
    <ul class="main" >
        <li>&lt;page&gt;</li>
...
<page pageset="old">
    <bookmark title="Propri&eacute;t&eacute;s" level="1" ></bookmark>
    <div class="note">
        La liste des propri&eacute;t&eacute;s utilisables est la suivante :<br>
    </div>
    <br>
    <table style="width: 100%">
        <tr style="vertical-align: top">
    ...
    <br>
    <ul class="main">
        <li>Les float ne sont g&eacute;r&eacute;s que pour la balise IMG.</li>
        <li>Elle ne permet g&eacute;n&eacute;ralement pas la conversion directe d'une page HTML en PDF, ni la conversion du r&eacute;sultat d'un WYSIWYG en PDF.</li>
        <li>Cette librairie est l&agrave; pour faciliter la g&eacute;n&eacute;ration de documents PDF, pas pour convertir n'importe quelle page HTML.</li>

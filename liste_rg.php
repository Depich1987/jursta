...
mysql_select_db($database_jursta, $jursta);
$query_liste_rolegeneral = "SELECT * FROM role_general, categorie_affaire WHERE ((categorie_affaire.id_categorieaffaire= role_general.id_categorieaffaire) AND (role_general.id_juridiction =".$row_select_juridic['id_juridiction'].") AND ((role_general.noordre_rolegeneral LIKE '".$_GET['wrdkey']."%') OR (role_general.demandeur_rolegeneral LIKE '".$_GET['wrdkey']."%') OR (role_general.defendeur_rolegeneral LIKE '".$_GET['wrdkey']."%'))) ORDER BY noordre_rolegeneral DESC";

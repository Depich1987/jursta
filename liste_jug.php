...
mysql_select_db($database_jursta, $jursta);
$query_liste_repjug = "SELECT * FROM rep_jugementsupp, role_general WHERE ((role_general.no_rolegeneral=rep_jugementsupp.no_rolegeneral) AND (rep_jugementsupp.id_juridiction =".$row_select_juridic['id_juridiction'].")AND ((rep_jugementsupp.nojugement_repjugementsupp LIKE '".$_GET['wrdkey']."%') OR (role_general.demandeur_rolegeneral LIKE '".$_GET['wrdkey']."%') OR (role_general.defendeur_rolegeneral LIKE '".$_GET['wrdkey']."%'))) ORDER BY nojugement_repjugementsupp DESC";

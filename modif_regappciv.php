...
mysql_select_db($database_jursta, $jursta);
$query_select_regapp = sprintf("SELECT * FROM reg_socialappel, role_general, rep_jugementsupp WHERE ((id_socialappel = %s) AND (role_general.no_rolegeneral=rep_jugementsupp.no_rolegeneral) AND (rep_jugementsupp.no_repjugementsupp=reg_socialappel.no_repjugementsupp))", GetSQLValueString($colname_select_regapp, "int"));
        ...
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
              <tr>
                ...
                <td class="Style10"><?php echo $row_select_regapp['noordre_rolegeneral']; ?></td>
                </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Demandeur : </td>
                <td class="Style10">                  <?php echo $row_select_regapp['demandeur_rolegeneral']; ?></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"> Defendeur : </td>
                <td class="Style10"><?php echo $row_select_regapp['defendeur_rolegeneral']; ?></td>
              </tr>
                </table></td>
              </tr>
              <tr>
              ...
              <tr>
                <td nowrap><input name="id_admin" type="hidden" id="id_admin" value="<?php echo $row_select_admin['Id_admin']; ?>">
                  ...
                  <input name="no_repjugementsupp" type="hidden" id="no_repjugementsupp" value="<?php echo $row_select_regapp['no_repjugementsupp']; ?>">

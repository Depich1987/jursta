...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE plum_regenfant SET dataudience_plumenfant=%s, presi_plumenfant=%s, greffier_plumenfant=%s, accesseurs_plumenfant=%s, observ_plumenfant=%s, id_noms=%s, Id_admin=%s, date_creation=%s, no_regplaintes=%s, id_juridiction=%s WHERE id_plumpenale=%s",
                       GetSQLValueString($_POST['dateaudience_plumenfant'], "date"),
                       ...
                       GetSQLValueString($_POST['id_plumenfant'], "int"));
        ...
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
              ...
              <tr>
                ...
                <td class="Style10"><input name="dateaudience_plumenfant" type="text" id="datepicker" value="<?php echo Change_formatDate($row_select_plumpenale['dataudience_plumenfant']); ?>"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Pr&eacute;sident : </td>
                <td><input value="<?php echo $row_select_plumpenale['presi_plumenfant']; ?>" name="presi_plumenfant" type="text" id="presi_plumenfant" size="30"></td>
              </tr>
              <tr class="Style10">
                <td align="right" valign="top" nowrap class="Style10">Greffier : </td>
                <td><input value="<?php echo $row_select_plumpenale['greffier_plumenfant']; ?>" name="greffier_plumenfant" type="text" id="greffier_plumenfant" size="30"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"> Accesseurs :</td>
                <td><textarea name="accesseurs_plumenfant" cols="30" rows="3" id="accesseurs_plumenfant"><?php echo $row_select_plumpenale['accesseurs_plumenfant']; ?></textarea></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Observation : </td>
                <td><textarea name="observ_plumenfant" cols="40" rows="7" id="observ_plumenfant"><?php echo $row_select_plumpenale['observ_plumenfant']; ?></textarea></td>
              </tr>
              <tr>
                <td nowrap><input name="id_admin" type="hidden" id="id_admin" value="<?php echo $row_select_plumpenale['Id_admin']; ?>">
                    ...
                    <input name="id_plumpenale" type="hidden" id="id_plumpenale" value="<?php echo $row_select_plumpenale['id_plumenfant']; ?>">

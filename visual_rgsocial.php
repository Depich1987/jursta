...
$query_select_rgsocial = sprintf("SELECT * FROM rg_social, categorie_affaire WHERE ((categorie_affaire.id_categorieaffaire=rg_social.id_categorieaffaire) AND (no_rgsocial = %s))", GetSQLValueString($colname_select_rgsocial, "int"));
...
mysql_select_db($database_jursta, $jursta);
$query_select_admin = "SELECT * FROM administrateurs WHERE Id_admin =".$row_select_rgsocial['Id_admin'];
          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="100%" class="Style2"><p>Le role g&eacute;n&eacute;ral - Visualiser un enregistrement</p></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="2">
              <tr bgcolor="#FFFFFF">
                ...
                <td class="Style10"><?php echo $row_select_rgsocial['no_rgsocial']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="top" nowrap bgcolor="#FFFFFF" class="Style10">N&deg; d'ordre : </td>
                <td class="Style10"><?php echo $row_select_rgsocial['noordre_rgsocial']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="top" nowrap bgcolor="#FFFFFF" class="Style10">Section : </td>
                <td class="Style10"><?php echo $row_select_rgsocial['lib_categorieaffaire']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="top" nowrap bgcolor="#FFFFFF" class="Style10">Date : </td>
                <td class="Style10"><?php echo Change_formatDate($row_select_rgsocial['date_rgsocial']); ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="top" nowrap bgcolor="#FFFFFF" class="Style10">Demandeur</td>
                <td class="Style10"><?php echo $row_select_rgsocial['demandeur_rgsocial']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="top" nowrap bgcolor="#FFFFFF" class="Style10">Defendeur</td>
                <td class="Style10"><?php echo $row_select_rgsocial['defendeur_rgsocial']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="top" nowrap bgcolor="#FFFFFF" class="Style10">Objet : </td>
                <td class="Style10"><?php echo $row_select_rgsocial['objet_rgsocial']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="top" nowrap bgcolor="#FFFFFF" class="Style10"> 1<sup>&egrave;re</sup>date d'audience</td>
                <td class="Style10"><?php echo Change_formatDate($row_select_rgsocial['dateaudience_rgsocial']); ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="top" nowrap bgcolor="#FFFFFF" class="Style10">Observation : </td>
                <td class="Style10"><?php echo $row_select_rgsocial['observation_rgsocial']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" nowrap bgcolor="#FFFFFF" class="Style10">Date de cr&eacute;ation : </td>
                <td class="Style10"><?php echo Change_formatDate($row_select_rgsocial['date_creation']); ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">

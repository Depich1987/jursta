...
mysql_select_db($database_jursta, $jursta);
$query_select_admin = "SELECT * FROM administrateurs WHERE Id_admin =".$row_select_regima['Id_admin'];
          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="100%" class="Style2"><p>Le registre d'immatriculation - Visualiser un enregistrement</p></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="2">
              ...
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="middle" nowrap bgcolor="#FFFFFF" class="Style10">Nom du Procureur : </td>
                <td class="Style10"><?php echo $row_select_regima['magistra_regmandat']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="middle" nowrap bgcolor="#FFFFFF" class="Style10"> <span class="Style10">Nature du d&eacute;lit</span> : </td>
              ...
              <tr bgcolor="#FFFFFF">
                ...
                <td class="Style10"><?php echo Change_formatDate($row_select_regima['date_creation']); ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">

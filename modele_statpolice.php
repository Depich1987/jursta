          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr>
                ...
                <td width="100%"><span class="Style2">FICHE STATISTIQUE DES DONNEES PROVENANTS 
DES SERVICES DE POLICE ET DE GENDAMERIE
ET DES SAISINES DE PARQUET
PERIODE DE 
</span> </td>
              </tr>
          </table></td>
        ...
        <tr>
          <td align="center" valign="middle" ><table width="940" cellpadding="3" cellspacing="0" >
              <tr bgcolor="#677787" class="Style15">
                <td align="right">Type de juridiction : </td>
                <td><select name="select">
                  <option>Cour Supr&egrave;me</option>
                  <option>Cour d'Appel</option>
                  <option>Tribunaux de Premi&egrave;re Instance</option>
                  <option>Sections D&eacute;tach&eacute;es</option>
                                                                </select></td>
                <td align="center">Juridiction : </td>
                <td><select name="select2">
                  <option>Cour d'appel d'ABIDJAN</option>
                  <option>Cour d'appel de BOUAKE</option>
                  <option>Cour d'appel de DALOA</option>
                                </select></td>
              ...
              <table width="940" cellpadding="3" cellspacing="0" >
                <tr>
                  <td><table height="175" cellpadding="3" cellspacing="0" >
                      <tr>
                        <td width="200" bgcolor="#6186AF" class="Style3">Autres informations </td>
                        <td width="246">&nbsp;</td>
                      </tr>
                      <tr bgcolor="#677787">
                        <td colspan="2" bgcolor="#6186AF"><table cellpadding="3" cellspacing="2" >
                            <tr class="Style15">
                              <td>Date : </td>
                              <td><input type="text" name="textfield"></td>
                              <td class="Style15">Nb. juge d'instruction : </td>
                              <td><input name="textfield3" type="text" size="3"></td>
                            </tr>
                            <tr class="Style15">
                              <td>Source : </td>
                              <td><input type="text" name="textfield2"></td>
                              <td class="Style15">Nb. chambre : </td>
                              <td><input name="textfield32" type="text" size="3"></td>
                            </tr>
                            <tr class="Style15">
                              <td rowspan="2" valign="top">Contacts : </td>
                              <td rowspan="2"><textarea name="textarea"></textarea></td>
                              <td class="Style15">Ch sp&eacute;ciale famille : </td>
                              <td><input name="textfield33" type="text" size="3"></td>
                            </tr>
                            <tr>
                              <td valign="top" class="Style15">Ch Sp&eacute;ciale de travail : </td>
                              <td valign="top"><input name="textfield34" type="text" size="3"></td>
                            </tr>
                        </table></td>
                      </tr>
                  ...
                  <td valign="top"><table cellpadding="3" cellspacing="0" >
                      <tr>
                        <td width="200" bgcolor="#6186AF" class="Style3">Statistiques personnels</td>
                        <td width="246">&nbsp;</td>
                      </tr>
                      <tr bgcolor="#677787">
                        <td colspan="2" bgcolor="#6186AF">                          <table width="100%" border="0" cellpadding="3" cellspacing="1" >
                            <tr bgcolor="#677787" class="Style3">
                              <td width="16%"><span class="Style10">Fonction membre de l'ordre </span></td>
                            ...
                            <tr bgcolor="#EDF0F3" class="Style14">
              ...
              <table width="940" cellpadding="3" cellspacing="1" >
                <tr>
                  ...
                  <td colspan="2" rowspan="2" align="center" bgcolor="#677787" class="Style15"><p>Constats Service de Police et de Gendamerie</p></td>
                  <td colspan="7" align="center" bgcolor="#677787" class="Style15"> Saisine des Parquets </td>
                </tr>
                <tr>
                  <td colspan="5" align="center" bgcolor="#677787" class="Style15"><p>Proc&egrave;s verbaux </p></td>
                  <td colspan="2" align="center" bgcolor="#677787" class="Style15">Autres Affaires P&eacute;nales</td>
                </tr>
                <tr bgcolor="#6186AF" class="Style15">
                  ...
                  <td align="center"><div align="center">Crimes et D&eacute;lits Elucit&eacute;s </div></td>
                  ...
                  <td align="center"> <div align="center">PV Crimes </div></td>
                  <td align="center"> <div align="center">PV d&eacute;lits </div></td>
                ...
                <tr bgcolor="#EDF0F3">
                  ...
                  <td class="Style15">Vol,Recels, Desctructions</td>
                  ...
                  <td align="center" class="Style22">12</td>
                  <td align="center" class="Style22">3</td>
                </tr>
                <tr bgcolor="#EDF0F3">
                  <td align="center" bgcolor="#EDF0F3" class="Style22">2</td>
                  <td class="Style15">Viol, Agression sexuelle</td>
                  <td align="center" class="Style22">134</td>
                  <td align="center" class="Style22">34</td>
                ...
                <tr bgcolor="#EDF0F3">
                  ...
                  <td class="Style15">Coups et Blessures volontaires</td>
                ...
                <tr bgcolor="#EDF0F3">
                  ...
                  <td class="Style15">Escroqueries, Abus de Confiance</td>
                  <td align="center" class="Style22">0</td>
                  <td align="center" class="Style22">0</td>
                  <td align="center" class="Style22">0</td>
                  <td align="center" class="Style22">0</td>
                ...
                <tr bgcolor="#EDF0F3">
                  ...
                  <td class="Style15">Atteintes aux moeurs</td>
                  <td align="center" class="Style22">0</td>
                  <td align="center" class="Style22">0</td>
                  <td align="center" class="Style22">0</td>
                  <td align="center" class="Style22">0</td>
                ...
                <tr bgcolor="#EDF0F3">
                  ...
                  <td class="Style15">Circulation Routi&egrave;re</td>
                  <td align="center" class="Style22">0</td>
                  <td align="center" class="Style22">0</td>
                  <td align="center" class="Style22">0</td>
                  <td align="center" class="Style22">0</td>

...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO role_general (noordre_rolegeneral, date_rolegeneral, demandeur_rolegeneral, defendeur_rolegeneral, objet_rolegeneral, observation_rolegeneral, Id_admin, date_creation) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="100%" class="Style2"><p>Le role g&eacute;n&eacute;ral - Ajouter un enregistrement</p></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
              ...
              <tr>
                ...
                <td><input name="date_rolegeneral" type="text" id="date_rolegeneral" size="15" value="<?php echo date("Y-m-d"); ?>"></td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Objet &amp; Audience : </td>
              ...
              <tr>
                ...
                <td><input type="submit" name="Valider_cmd" value="   Supprimer l'enregistrement   "></td>
              </tr>
          </table></td>
        </tr>
      </table></td>

...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO type_juridiction (id_typejuridiction, lib_typejuridiction, id_admin, date_creation) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($_POST['id_typejuridiction'], "int"),
                       GetSQLValueString($_POST['lib_typejuridiction'], "text"),
        ...
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
              <tr>
                ...
                <td><input name="id_typejuridiction" type="text" id="id_typejuridiction" size="11"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">D&eacute;signation : </td>
                <td><input name="lib_typejuridiction" type="text" id="lib_typejuridiction" size="30"></td>
              </tr>
              <tr>

...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO reg_cahiercharge (noordre_cc, date_cc, demandeur_cc, defendeur_cc, objet_cc, observation_cc, Id_admin, date_creation, id_categorieaffaire, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="100%" class="Style2"><p>Le cahier des charges- Ajouter un enregistrement </p></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
              <tr>
                ...
                <td><input name="noordre_cc" type="text" id="noordre_cc" size="20"></td>
              </tr>
              <tr>
...
?>
              ...
              <tr>
                ...
                <td><input name="date_cc" type="text" id="datepicker1" size="15" value="<?php echo date("d/m/Y"); ?>"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Demandeur</td>
                <td><input name="demandeur_cc" type="text" id="demandeur_cc" size="35"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Defendeur</td>
                <td><input name="defendeur_cc" type="text" id="defendeur_cc" size="35"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Objet: </td>
                <td><textarea name="objet_cc" cols="40" rows="5" id="objet_cc"></textarea></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Observation : </td>
                <td><textarea name="observation_cc" cols="40" rows="7" id="observation_cc"></textarea></td>
              </tr>
              <tr>

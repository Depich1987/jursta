        ...
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="2">
              <tr bgcolor="#FFFFFF">
                ...
                <td class="Style10"><?php echo $row_select_plumpenale['id_plumpenale']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="top" bgcolor="#FFFFFF" class="Style10"><span class="Style10">Audience du </span> : </td>
                <td class="Style10"><?php echo Change_formatDate($row_select_plumpenale['dataudience_plumpenale']); ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="top" bgcolor="#FFFFFF" class="Style10">  Pr&eacute;sident : </td>
                <td class="Style10"><?php echo $row_select_plumpenale['presi_plumpenale']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="top" bgcolor="#FFFFFF" class="Style10">Greffiers : </td>
                <td class="Style10"><?php echo $row_select_plumpenale['greffier_plumpenale']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="top" bgcolor="#FFFFFF" class="Style10">Accesseurs : </td>
                <td class="Style10"><?php echo $row_select_plumpenale['accesseurs_plumpenale']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="top" bgcolor="#FFFFFF" class="Style10"><p>Nom des parties  /</p>
                  <p> Infraction : </p></td>
              ...
              <tr bgcolor="#FFFFFF">
                ...
                <td class="Style10"><?php echo $row_select_plumpenale['observ_plumpenale']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">

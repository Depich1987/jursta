...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO reg_scelle (nodordre_regscel, datedepo_regscel, nomdeposant_regscel, objetdepo_regscel, observation_regscel, Id_admin, date_creation, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="100%" class="Style2"><p>Le registre de transmission des scell&eacute;s - Ajouter un enregistrement</p></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
              <tr>
                ...
                <td><input name="nodordre_regscel" type="text" id="nodordre_regscell" size="20"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"><span class="Style10">Date de d&eacute;p&ocirc;t</span> : </td>
                <td><input name="datedepo_regscel" type="text" id="datedepo_regscell" size="15" value="<?php echo date("d-m-Y"); ?>"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"><span class="Style10">Nom du d&eacute;posant</span> :</td>
                <td>                  <textarea name="nomdeposant_regscel" cols="40" rows="2" id="nomdeposant_regscel"></textarea></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">D&eacute;signation des objets d&eacute;pos&eacute;s :</td>
                <td><textarea name="objetdepo_regscel" cols="35" rows="5" id="objetdepo_regscel"></textarea></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"><span class="Style10">Observation</span> :</td>
                <td><textarea name="observation_regscel" cols="35" rows="4" id="observation_regscel"></textarea></td>
              </tr>
              <tr>

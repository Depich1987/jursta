...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO reg_libcond (numordre_reglibcond, date_libcond, ref_reglibcond, obs_reglibcond, no_ecrou, signature_greffier, Id_admin, date_creation, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['numordre_reglibcond'], "text"),
                       GetSQLValueString($_POST['date_libcond'], "date"),
                       GetSQLValueString($_POST['ref_reglibcond'], "text"),
                       GetSQLValueString($_POST['obs_reglibcond'], "text"),
          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="100%" class="Style2"><p>Le registre des lib&eacute;rations conditionnelles- Ajouter un enregistrement</p></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tr>
              <td align="right" valign="top" nowrap bgcolor="#CCE3FF" class="Style10"><form name="form1" method="post" action="add_reglibcond.php">
                  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                    <tr>
                      <td align="right" valign="middle" nowrap class="Style10">N&deg; Ecrou :</td>
                      <td><input name="noordre_regmandat" type="text" id="noordre_regmandat" value="<?php echo $row_select_nodossier['noordre_ecrou']; ?>" size="15"></td>
                ...
                <form action="<?php echo $editFormAction; ?>" name="form2" method="POST">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    <tr>
                      ...
                      <td colspan="2"><input name="numordre_reglibcond" type="text" id="numordre_reglibcond" size="15"></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top" nowrap class="Style10">Date de liberation : </td>
                      <td colspan="2"><input name="date_libcond" type="text" id="datepicker" size="15" value="<?php echo date("d/m/Y"); ?>"></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top" nowrap class="Style10">R&eacute;ference :</td>
                      <td colspan="2"><input name="ref_reglibcond" type="text" id="ref_reglibcond" size="30"></td>
                    </tr>
                    
                    <tr>
                      <td align="right" valign="top" nowrap class="Style10">Observation : </td>
                      <td colspan="2"><textarea name="obs_reglibcond" cols="30" rows="4" id="obs_reglibcond"></textarea></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top" nowrap class="Style10">Pr&eacute;pos&eacute; au greffe :</td>
                      <td colspan="2"><textarea name="signature_greffier" cols="40" rows="2" readonly="readonly" id="signature_greffier">Approuv&eacute;e par <?php echo $row_select_admin['nom_admin']; ?> <?php echo $row_select_admin['prenoms_admin']; ?> le : <?php echo Change_formatDate(date("Y-m-d H:i:s")); ?></textarea></td>
                    </tr>
                    <tr>

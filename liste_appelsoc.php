...
mysql_select_db($database_jursta, $jursta);
$query_liste_appelsocial = "SELECT * FROM reg_socialappel, rep_decision, rg_social WHERE ((rg_social.no_rgsocial=rep_decision.no_rgsocial) AND(reg_socialappel.no_decision=rep_decision.no_decision) AND ((reg_socialappel.no_socialappel LIKE '".$_GET['wrdkey']."%') OR (rg_social.demandeur_rgsocial LIKE '".$_GET['wrdkey']."%') OR (rg_social.defendeur_rgsocial LIKE '".$_GET['wrdkey']."%'))) ORDER BY id_socialappel DESC";

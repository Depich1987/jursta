...
<table width="940"  border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td width="100%" valign="top"><?php if ((isset($_POST["Executer_cmd"])) && ($_POST["Executer_cmd"] == "Exécuter")) { ?>
                            ...
                            <ul>
                              ...
                              <textarea name="textarea" id="textarea" cols="45" rows="5"><?php echo $sql_insert_t31; ?></textarea>
                              <?php } ?>
                              <?php if ($_POST['stat_chk2']=="CIVILS"){?><li class="Style22"> Statistiques Civils, Commerciales et administratives<br>
                              </li>
                              <textarea name="textarea3" id="textarea3" cols="45" rows="5"><?php echo $sql_insert_t36; ?></textarea>
                              <?php } ?>
                              <?php if ($_POST['stat_chk3']=="SOCIALES"){?><li class="Style22"> Statistiques Sociales<br>
                              </li>
                              <textarea name="textarea4" id="textarea4" cols="45" rows="5"><?php echo $sql_insert_t36; ?></textarea>
                              <?php } ?>
                              <?php if ($_POST['stat_chk4']=="PENITENTIAIRES"){?><li class="Style22">Statistiques des administrations P&eacute;nitentiaires                                
                                <br>
                                <textarea name="textarea5" id="textarea5" cols="45" rows="5"><?php echo $sql_insert_t36; ?></textarea><?php } ?>
                              </li>
                              <li class="Style22"><span class="Style22">informations compl&eacute;mentaires<br>
                                  <textarea name="textarea2" id="textarea2" cols="45" rows="5"><?php echo $sql_insert_t30; ?></textarea></span>
                                <?php } ?>
                                <textarea name="textarea6" id="textarea6" cols="45" rows="5"><?php echo $sql_insert_t30; ?><?php echo $sql_insert_t31; ?><?php echo $sql_insert_t36; ?></textarea>
                                </li>
                              </ul>
                            <div id="preload">
  <table width="100%" border="0" cellpadding="5" cellspacing="5">
							  ...
							  <script language="javascript">ShowHide('preload','s');</script></td>
                        </tr>
                      </table>                        </td>
                    </tr>
                </table></td>

...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO reg_cabin (numodre_regcabin, datefait, daterequisitoire, datordcloture, decisionord, observation, no_repjugementcorr, Id_admin, date_creation, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString(changedatefrus($_POST['numodre_regcabin']), "text"),
                       ...
                       GetSQLValueString(changedatefrus($_POST['decisionord']), "text"),
...
mysql_select_db($database_jursta, $jursta);
$query_select_cabin = "SELECT max(numodre_regcabin)  FROM reg_cabin";
...
?>
<?php 
	$ri= substr($row_select_cabin['max(numodre_regcabin)'], 2, 2);
	$tr="RI";
?>
<?php  if ($ri+1<10) {
	$tr="RI0";
...
<table width="600" align="center" >
  <tr>
    <td align="center" bgcolor="#CCE3FF"><table border="0" cellpadding="2" cellspacing="2">
        ...
        <tr>
          <td valign="middle"><table border="0" align="center" cellpadding="5" cellspacing="0">
            <tr>
              <td align="center" valign="top" nowrap class="Style10"><form name="form1" method="post" action="add_regcabin.php">
...
<?php if ($totalRows_select_nodossier > 0) { // Show if recordset not empty ?>
                    <tr>
                      <td colspan="3" align="center" valign="middle" nowrap bgcolor="#999999" class="Style10">Nom des parties / Nature de l'infraction :                        </td>
                    </tr>
                    <tr>
                      <td colspan="3" align="center" valign="middle" bgcolor="#FFFFFF" class="Style10"><table border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF" class="Style10">
                        <?php do { ?>
        ...
        <tr>
          <td width="100%" valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tr>
              ...
              <td><input name="numodre_regcabin" type="text" id="numodre_regcabin" size="15" value="<?php  echo ($tr);?><?php  echo ($ri);?>/<?php echo date('y');?>"></td>
              </tr>
            <tr>
            ...
            <tr>
              <td nowrap><input name="id_admin" type="hidden" id="id_admin" value="<?php echo $row_select_admin['Id_admin']; ?>">
                ...
                <input name="no_repjugementcorr" type="hidden" id="no_repjugementcorr" value="<?php echo $row_select_nodossier['no_repjugementcorr']; ?>"></td>

          ...
          <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="2" cellspacing="2">
              <tr>
                <td width="100%" valign="middle" >
                  <table width="100%" >
                    <tr>
                      <td valign="top"><span class="Style2"><a href="stat_oientationaffair.php"><img src="images/forms48.png" width="32" border="0"></a></span></td>
                      <td width="100%"><div align="center">
                        ...
                        <p class="Style2">FICHE STATISTIQUE DES ORIENTATIONS DES AFFAIRES DU PARQUET
<?php 
                    ...
                    <tr>
                      <td bgcolor="#000000"><table width="940" cellpadding="3" cellspacing="1" >
                        <tr class="Style22">
                          ...
                          <td colspan="6" align="center" valign="middle" bgcolor="#FFFFFF" class="Style10"> AFFAIRES POURSUIVABLES </td>
                        </tr>
                        <tr bgcolor="#6186AF" class="Style11">
                          <td align="center" bgcolor="#FFFFFF">#</td>
                          <td width="100%" align="center" bgcolor="#FFFFFF">Nature</td>
                          <td align="center" bgcolor="#FFFFFF"><div align="center">Affaires<br>
                            Non <br>
                            poursuivables</div>
                            <div align="center"></div></td>
                          <td align="center" bgcolor="#FFFFFF"><div align="center">Toutes<br>
                            les affaires<br>
                          ...
                          <td align="center" bgcolor="#FFFFFF"><p align="center">Nb. Proc&eacute;dures<br>
                            Alternatives</p></td>
                          <td align="center" bgcolor="#FFFFFF"><div align="center">Nb. proc&eacute;dures<br>
                            Class&eacute;es<br>
                            Sans Suite</div></td>
                        </tr>
                        <?php $h=0; ?>
...
mysql_select_db($database_jursta, $jursta);
$query_affairesnonpoursuivables = "SELECT count(*) as affairesnonpoursuivables FROM reg_plaintes, administrateurs WHERE ((administrateurs.Id_admin=reg_plaintes.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (reg_plaintes.naturesuite_plaintes='Non Poursuivable') AND (substr(reg_plaintes.date_creation,6,2)='".$mois_affairesnonpoursuivables."') AND (substr(reg_plaintes.date_creation,1,4)='".$annee_affairesnonpoursuivables."') AND (reg_plaintes.id_categorieaffaire=".$categorie."))";
...
mysql_select_db($database_jursta, $jursta);
$query_affairespoursuivables = "SELECT count(*) as affairespoursuivables FROM reg_plaintes, administrateurs WHERE ((administrateurs.Id_admin=reg_plaintes.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (reg_plaintes.naturesuite_plaintes='Poursuivable') AND (substr(reg_plaintes.date_creation,6,2)='".$mois_affairespoursuivables."') AND (substr(reg_plaintes.date_creation,1,4)='".$annee_affairespoursuivables."') AND (reg_plaintes.id_categorieaffaire=".$categorie."))";
...
mysql_select_db($database_jursta, $jursta);
$query_transmisjugeinstrution = "SELECT count(*) as transmisjugeinstrution FROM reg_plaintes, administrateurs WHERE ((administrateurs.Id_admin=reg_plaintes.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (reg_plaintes.suite_plaintes='Juge d''instruction') AND (substr(reg_plaintes.date_creation,6,2)='".$mois_transmisjugeinstrution."') AND (substr(reg_plaintes.date_creation,1,4)='".$annee_transmisjugeinstrution."') AND (reg_plaintes.id_categorieaffaire=".$categorie."))";
...
mysql_select_db($database_jursta, $jursta);
$query_transmisjugeenfants = "SELECT count(*) as transmisjugeenfants FROM reg_plaintes, administrateurs WHERE ((administrateurs.Id_admin=reg_plaintes.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (reg_plaintes.suite_plaintes='Juge des enfants') AND (substr(reg_plaintes.date_creation,6,2)='".$mois_transmisjugeenfants."') AND (substr(reg_plaintes.date_creation,1,4)='".$annee_transmisjugeenfants."') AND (reg_plaintes.id_categorieaffaire=".$categorie."))";
...
mysql_select_db($database_jursta, $jursta);
$query_transmistribunalcorrectionnel = "SELECT count(*) as transmistribunalcorrectionnel FROM reg_plaintes, administrateurs WHERE ((administrateurs.Id_admin=reg_plaintes.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (reg_plaintes.suite_plaintes='Tribunal correctionnel') AND (substr(reg_plaintes.date_creation,6,2)='".$mois_transmistribunalcorrectionnel."') AND (substr(reg_plaintes.date_creation,1,4)='".$annee_transmistribunalcorrectionnel."') AND (reg_plaintes.id_categorieaffaire=".$categorie."))";
...
mysql_select_db($database_jursta, $jursta);
$query_affairesclassesanssuite = "SELECT count(*) as affairesclassesanssuite FROM reg_plaintes, administrateurs WHERE ((administrateurs.Id_admin=reg_plaintes.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (reg_plaintes.naturesuite_plaintes='Class&eacute;e') AND (substr(reg_plaintes.date_creation,6,2)='".$mois_affairesclassesanssuite."') AND (substr(reg_plaintes.date_creation,1,4)='".$annee_affairesclassesanssuite."') AND (reg_plaintes.id_categorieaffaire=".$categorie."))";
...
mysql_select_db($database_jursta, $jursta);
$query_total_affairnonpoursuivable = "SELECT count(*) as affairesnonpoursuivables FROM reg_plaintes, administrateurs WHERE ((administrateurs.Id_admin=reg_plaintes.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (reg_plaintes.naturesuite_plaintes='Non Poursuivable') AND (substr(reg_plaintes.date_creation,6,2)='".$mois_affairesnonpoursuivables."') AND (substr(reg_plaintes.date_creation,1,4)='".$annee_affairesnonpoursuivables."'))";
...
mysql_select_db($database_jursta, $jursta);
$query_total_affairpoursuivable = "SELECT count(*) as affairespoursuivables FROM reg_plaintes, administrateurs WHERE ((administrateurs.Id_admin=reg_plaintes.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (reg_plaintes.naturesuite_plaintes='Poursuivable') AND (substr(reg_plaintes.date_creation,6,2)='".$mois_affairespoursuivables."') AND (substr(reg_plaintes.date_creation,1,4)='".$annee_affairespoursuivables."'))";
...
mysql_select_db($database_jursta, $jursta);
$query_total_tjugenfants = "SELECT count(*) as transmisjugeenfants FROM reg_plaintes, administrateurs WHERE ((administrateurs.Id_admin=reg_plaintes.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (reg_plaintes.suite_plaintes='Juge des enfants') AND (substr(reg_plaintes.date_creation,6,2)='".$mois_transmisjugeenfants."') AND (substr(reg_plaintes.date_creation,1,4)='".$annee_transmisjugeenfants."'))";
...
mysql_select_db($database_jursta, $jursta);
$query_total_affairsanssuite = "SELECT count(*) as affairesclassesanssuite FROM reg_plaintes, administrateurs WHERE ((administrateurs.Id_admin=reg_plaintes.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (reg_plaintes.naturesuite_plaintes='Class&eacute;e') AND (substr(reg_plaintes.date_creation,6,2)='".$mois_affairesclassesanssuite."') AND (substr(reg_plaintes.date_creation,1,4)='".$annee_affairesclassesanssuite."'))";
...
?>
                        <tr bgcolor="#EDF0F3" class="Style22">
                          ...
                          <td align="center" bgcolor="#FFFFFF" class="Style22"><?php echo $row_affairesnonpoursuivables['affairesnonpoursuivables']; ?></td>
                          <td align="center" bgcolor="#FFFFFF" class="Style22"><?php echo $row_affairespoursuivables['affairespoursuivables']; ?></td>
                          <td align="center" bgcolor="#FFFFFF" class="Style22"><?php echo $row_transmisjugeinstrution['transmisjugeinstrution']; ?></td>
                          <td align="center" bgcolor="#FFFFFF" class="Style22"><?php echo $row_transmisjugeenfants['transmisjugeenfants']; ?></td>
                          <td align="center" bgcolor="#FFFFFF" class="Style22"><?php echo $row_transmistribunalcorrectionnel['transmistribunalcorrectionnel']; ?></td>
                          <td align="center" bgcolor="#FFFFFF" class="Style22">0</td>
                          <td align="center" bgcolor="#FFFFFF" class="Style22"><?php echo $row_affairesclassesanssuite['affairesclassesanssuite']; ?></td>
                        </tr>
                        ...
                        <tr align="center" bgcolor="#677787" class="Style11">
                          ...
                          <td bgcolor="#FFFFFF" class="Style22"><strong><?php echo $row_total_affairnonpoursuivable['affairesnonpoursuivables']; ?> </strong></td>
                          <td bgcolor="#FFFFFF" class="Style22"><strong><?php echo $row_total_affairpoursuivable['affairespoursuivables']; ?> </strong></td>
                          <td bgcolor="#FFFFFF" class="Style22"><strong><?php echo $row_total_tjuginstruction['transmisjugeinstrution']; ?></strong></td>
                          <td bgcolor="#FFFFFF" class="Style22"><strong><?php echo $row_total_tjugenfants['transmisjugeenfants']; ?></strong></td>
                          <td bgcolor="#FFFFFF" class="Style22"><strong><?php echo $row_total_tjugcorectionnel['transmistribunalcorrectionnel']; ?></strong></td>
                          <td bgcolor="#FFFFFF" class="Style22"><strong>0</strong></td>
                          <td bgcolor="#FFFFFF" class="Style22"><strong><?php echo $row_total_affairsanssuite['affairesclassesanssuite']; ?></strong></td>
                        </tr>
                        <tr bgcolor="#677787">
                          <td colspan="9" align="center" bgcolor="#FFFFFF" class="Style22"><img src="images/spacer.gif" width="1" height="1"></td>
                        </tr>
                      </table></td>
                    </tr>
                  </table>

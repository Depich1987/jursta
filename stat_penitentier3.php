          ...
          <td align="center" valign="middle" ><table width="940" cellpadding="3" cellspacing="0" >
              ...
              <table width="940" cellpadding="3" cellspacing="1" >
                <tr bgcolor="#6186AF" class="Style15">
                  <td align="center">#</td>
                  <td align="center">Listing des Etablissements</td>
                  <td colspan="2" align="center">Effectif du personnel</td>
                </tr>
                <tr bgcolor="#EDF0F3">
                  <td rowspan="3" valign="top" bgcolor="#EDF0F3" class="Style22"><table width="100%" cellpadding="0" cellspacing="0" class="Style15">
                    <tr>
                      <td>&nbsp;</td>
                    </tr>
                  </table></td>
                  <td rowspan="3" valign="top" bgcolor="#EDF0F3" class="Style15"><table width="100%" cellpadding="0" cellspacing="0" class="Style15">
                    <tr>
                      <td>Abengourou</td>
                    </tr>
                  </table></td>
                  <td align="right" bgcolor="#FFFFFF" class="Style15"><table width="100%" cellpadding="2" cellspacing="2" class="Style15">
                      <tr align="center" bgcolor="#CCCCCC">
                        <td>D&eacute;signation</td>
                        <td>Abr&eacute;viation</td>
                        <td nowrap>Eff. Id&eacute;al</td>
                        <td nowrap>Eff. actuel</td>
                        <td nowrap>Poste &agrave; Lib&eacute;rer<br>
            pour retraite</td>
                        <td nowrap class="Style15">Poste &agrave; Lib&eacute;rer<br>
            pour Cause Temp.</td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                ...
                <tr bgcolor="#6186AF">
                  <td colspan="2" align="center" class="Style15">Statistiques des Pathologies en Milieu Carc&eacute;ral</td>
                </tr>
                <tr bgcolor="#EDF0F3">
                  <td colspan="2" align="right" class="Style15"><table width="100%" cellpadding="2" cellspacing="2" class="Style15">
                      <tr align="center" bgcolor="#CCCCCC">
                        <td>Pathologie</td>
                        <td>Nbre. Cas</td>
                        <td nowrap>Nbre. Hommes</td>
                        <td nowrap>Nbre.Femmes </td>
                        <td nowrap>Nbre Mineurs</td>
                        <td nowrap class="Style15">Nbre. D&eacute;c&egrave;s</td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>

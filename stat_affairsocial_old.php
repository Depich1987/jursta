                ...
                <td width="100%" valign="middle" >
                  <table width="100%" >
                    <tr>
                      ...
                      <td width="100%" align="center"><span class="Style2">FICHE STATISTIQUE DES AFFAIRES SOCIALES
                            <?php echo("P&eacute;riode du ".$_SESSION['datedebut']." au ".$_SESSION['datefin']); 
							 ?> 
                      </span> </td>
                    </tr>
                </table></td>
...
mysql_select_db($database_jursta, $jursta);
$query_demanderejete = "SELECT count(*) as demanderejete FROM administrateurs, rep_jugementsupp, rg_social WHERE ((administrateurs.Id_admin=rep_jugementsupp.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (rg_social.date_creation BETWEEN '".$datedebut."' AND '".$datefin."') AND (rg_social.id_categorieaffaire=".$categorie.") AND (rep_jugementsupp.statut_jugementsupp='Rejetée')  AND (rg_social.no_rgsocial=rep_jugementsupp.no_rgsocial))";
...
mysql_select_db($database_jursta, $jursta);
$query_total_demandeaccepte = "SELECT count(*) as demandeaccepte FROM administrateurs, rep_jugementsupp, rg_social WHERE ((administrateurs.Id_admin=rep_jugementsupp.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (rg_social.date_creation BETWEEN '".$datedebut."' AND '".$datefin."') AND (rep_jugementsupp.statut_jugementsupp='Acceptée')  AND (rg_social.no_rgsocial=rep_jugementsupp.no_rgsocial))";
...
mysql_select_db($database_jursta, $jursta);
$query_total_demanderejete = "SELECT count(*) as demanderejete FROM administrateurs, rep_jugementsupp, rg_social WHERE ((administrateurs.Id_admin=rep_jugementsupp.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (rg_social.date_creation BETWEEN '".$datedebut."' AND '".$datefin."') AND (rep_jugementsupp.statut_jugementsupp='Rejetée')  AND (rg_social.no_rgsocial=rep_jugementsupp.no_rgsocial))";
...
?>
                    <tr bgcolor="#EDF0F3">
                      ...
                      <td align="center" class="Style22"><?php echo Change_formatDate($row_liste_acte['nbacte']+$row_liste_actecc['nbactecc']); ?></td>
                    </tr>
                    ...
                    <tr align="center" bgcolor="#677787" class="Style11">
                      ...
                      <td class="Style22"><strong><?php echo $row_total_nbactecc['nbactecc']; ?></strong></td>
                    </tr>
                    <tr bgcolor="#677787">

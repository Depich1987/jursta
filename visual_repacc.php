...
mysql_select_db($database_jursta, $jursta);
$query_select_admin = "SELECT * FROM administrateurs WHERE Id_admin =".$row_select_repacc['Id_admin'];
          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="100%" class="Style2"><p>Attestation de la chambre civile  - Visualiser un enregistrement</p></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="2">
              <tr bgcolor="#FFFFFF">
                ...
                <td class="Style10"><?php echo $row_select_repacc['no_repactesacc']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="top" nowrap bgcolor="#FFFFFF" class="Style10">N&deg; d'ordre :</td>
                <td class="Style10"><?php echo $row_select_repacc['nodordre_acc']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="top" nowrap bgcolor="#FFFFFF" class="Style10">Date  :</td>
                <td class="Style10"><?php echo Change_formatDate($row_select_repacc['date_acc']); ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="top" nowrap bgcolor="#FFFFFF" class="Style10">Nom des parties:</td>
                <td class="Style10"><?php echo $row_select_repacc['nomparties_acc']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="top" nowrap bgcolor="#FFFFFF" class="Style10">D&eacute;signation de l'acte:</td>
                <td class="Style10"><?php echo $row_select_repacc['designationacte_acc']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" nowrap bgcolor="#FFFFFF" class="Style10">Date de cr&eacute;ation : </td>
                <td class="Style10"><?php echo Change_formatDate($row_select_repacc['date_creation']); ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">

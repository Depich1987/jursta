...
mysql_select_db($database_jursta, $jursta);
$query_select_admin = "SELECT * FROM administrateurs WHERE Id_admin =".$row_select_regmandat['Id_admin'];
          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="100%" class="Style2"><p>Le registre des Mandats et Recommand&eacute;s - Visualiser un enregistrement</p></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="2">
              ...
              <tr bgcolor="#FFFFFF">
                ...
                <td class="Style10"><?php echo $row_select_regmandat['magistra_regmandat']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" valign="middle" nowrap bgcolor="#FFFFFF" class="Style10">Infraction : </td>
                <td class="Style10"><?php echo $row_select_regmandat['infraction_regmandat']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
                <td height="35" align="right" nowrap bgcolor="#FFFFFF" class="Style10"><span class="Style10">Date de cr&eacute;ation</span> : </td>
                <td class="Style10"><?php echo Change_formatDate($row_select_regmandat['date_creation']); ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">

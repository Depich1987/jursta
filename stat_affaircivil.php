                ...
                <td width="100%" valign="middle" >
                  <table width="100%" >
                    <tr>
                      ...
                      <td width="100%" align="center"><p class="Style2">FICHE STATISTIQUE DES AFFAIRES CIVILES ET COMMERCIALES
                            <br><?php echo ("P&eacute;riode du ".$datedeb." au ".$datef); ?></br>
                         <?php echo $juridiction;?></p>
                      </td>
                    </tr>
                </table></td>
              </tr>
...
mysql_select_db($database_jursta, $jursta);
$query_jugdefaut = "SELECT count(*) as jugdefaut FROM administrateurs, rep_jugementsupp, role_general WHERE ((administrateurs.Id_admin=rep_jugementsupp.Id_admin) AND (administrateurs.id_juridiction=".$juridiction.") AND (role_general.date_creation BETWEEN '".$datedebut."' AND '".$datefin."') AND (role_general.id_categorieaffaire=".$categorie.") AND (rep_jugementsupp.dispositif_repjugementsupp='Défaut')  AND (role_general.no_rolegeneral=rep_jugementsupp.no_rolegeneral))";
...
<tr bgcolor="#EDF0F3">
                      ...
                      <td align="center" class="Style22"><?php echo $row_affairesprecedent['affairesprecedent']; ?></td>
                      <td align="center" class="Style22"><?php echo $row_affairesenrolees['affairesenrolees']; ?></td>
...
<tr align="center" bgcolor="#677787" class="Style11">
                      ...
                      <td class="Style22"><strong><?php echo $row_total_affairprecedente['affairesprecedent']; ?></strong></td>
                      <td class="Style22"><strong> <?php echo $row_totalaffairesenrolees['affairesenrolees']; ?></strong></td>
                      <td class="Style22"><strong><?php echo $row_totaldemandeaccepte['demandeaccepte']; ?></strong></td>
                      <td class="Style22"><strong><?php echo $row_totaldemanderejete['demanderejete']; ?></strong></td>
                      <td class="Style22"><strong><?php echo $row_Total_jugcontradictoires['jugcontradictoires']; ?></strong></td>
                      <td class="Style22"><strong><?php echo $row_total_jugincompetence['jugincompetence']; ?></strong></td>
                      <td class="Style22"><strong><?php echo $row_total_jugradiatiation['jugradiatiation']; ?></strong></td>
                      <td class="Style22"><strong><?php echo $row_total_jugdefaut['jugdefaut']; ?></strong></td>
                      <td class="Style22"><strong><?php echo ($row_total_affairprecedente['affairesprecedent']+$row_totalaffairesenrolees['affairesenrolees'])-($row_Total_jugcontradictoires['jugcontradictoires']+$row_total_jugdefaut['jugdefaut']+$row_total_jugincompetence['jugincompetence']+$row_total_jugradiatiation['jugradiatiation']);?></strong></td>
                      <td class="Style22"><?php echo $moyenne; ?></td>
                      <td class="Style22"><strong><?php echo ($row_total_nbacte['nbacte']+$row_total_nactcc['nbacte']); ?></strong></td>
                    </tr>
                    <tr bgcolor="#677787">
                      <td colspan="13" align="center" class="Style22"><img src="images/spacer.gif" width="1" height="1"></td>
                    </tr>
                  </table>
<form action="statistiquecivillpdf.php" method="post" name="form2" id="form2">
  <?php if ($row_select_juridiction['id_juridiction'] == 55) { // Show if recordset empty ?>
...
mysql_free_result($dure_moyenne);

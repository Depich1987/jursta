...
if ((isset($_GET['noregdec'])) && ($_GET['noregdec'] != "")) {
  $deleteSQL = sprintf("DELETE FROM reg_deces WHERE id_regdeces=%s",
...
mysql_select_db($database_jursta, $jursta);
$query_liste_deces = "SELECT * FROM reg_deces, reg_ecrou, reg_controlnum, reg_mandat WHERE ((reg_deces.id_juridiction =".$row_select_juridic['id_juridiction'].") AND (reg_deces.no_ecrou = reg_ecrou.no_ecrou) AND (reg_ecrou.no_regcontrolnum = reg_controlnum.no_regcontrolnum) AND (reg_mandat.no_regmandat=reg_controlnum.no_regmandat) AND ((reg_deces.numodre_regdeces LIKE '".$_GET['wrdkey']."%') OR (reg_ecrou.noordre_ecrou LIKE '".$_GET['wrdkey']."%') OR (reg_mandat.nom_regmandat LIKE '".$_GET['wrdkey']."%') OR (reg_deces.date_regdeces LIKE '".Change_formatDate($_GET ['wrdkey'])."%'))) ORDER BY reg_deces.id_regdeces DESC";
                                    ...
                                    <tr>
                                      <td bgcolor="#6186AF"><table width="100%" border="0" cellpadding="3" cellspacing="1">
                                          <tr bgcolor="#677787" class="Style3">
                                            ...
                                            <td>Identit&eacute; et Signalement</td>
                                            <td><span class="Style11">Date et lieu de d&eacute;c&egrave;s</span></td>
                                            <td nowrap><span class="Style11">Circonstance d&eacute;tailles du d&eacute;c&egrave;s</span></td>
                                            <td align="center" nowrap><span class="Style11">Suite r&eacute;serv&eacute;e </span></td>
...
?>
                                          <tr bgcolor="<?php echo $tabcolor ?>" class="Style14">
                                            ...
                                            <td align="left" valign="top"  class="Style11"><p><strong>Nom :<?php echo $row_liste_deces['nom_regmandat']; ?></strong></p>
                                              <p><strong>Date de daissance : <?php echo Change_formatDate($row_liste_deces['datnaisdet_ecrou']); ?></strong></p>
                                              <p><strong>A : <?php echo $row_liste_deces['lieunaisdet_ecrou']; ?></strong></p>
                                              <p><strong>Domiciliation : <?php echo $row_liste_deces['domicildet_ecrou']; ?></strong></p>
                                              <p><strong>Nationnalit&eacute; : </strong></p></td>
                                            <td valign="middle" nowrap class="Style11"><p><strong><?php echo Change_formatDate($row_liste_deces['date_regdeces']); ?></strong></p>
                                              <strong>&nbsp;<?php echo $row_liste_deces['lieu_regdeces']; ?></strong></td>
                                            <td valign="middle" class="Style11"><strong><?php echo $row_liste_deces['details_regdeces']; ?></strong></td>
                                            <td align="center" valign="middle" class="Style11"><strong><?php echo $row_liste_deces['suite_regdeces']; ?></strong></td>
                                            <td align="center" valign="middle" class="Style11"><strong><?php echo $row_liste_deces['observation_regdeces']; ?></strong></td>

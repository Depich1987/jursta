...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO plum_civil (presi_plumcivil, greffier_plumcivil, accesseurs_plumcivil, Substitut_PlumCivil, type_affaire, observ_plumcivil, Id_admin, date_creation, no_rolegeneral, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['substitut_plumcivil'], "text"),
          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="100%" class="Style2"><p>Plumitif Civil  - Ajouter un enregistrement</p></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tr>
              <td align="right" valign="top" nowrap bgcolor="#CCE3FF" class="Style10"><form name="form1" method="post" action="add_plumcivil.php">
                ...
                <form action="<?php echo $editFormAction; ?>" name="form2" method="POST">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    <tr class="Style10">
                      ...
                      <td colspan="2"><input name="presi_plumcivil" type="text" id="presi_plumcivil" size="30"></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top" nowrap class="Style10">Assesseurs  :</td>
                      <td colspan="2"><textarea name="accesseurs_plumcivil" cols="30" rows="3" id="accesseurs_plumcivil"></textarea></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top" nowrap class="Style10"> Substitut du P.R :</td>
                      <td colspan="2"><input name="substitut_plumcivil" type="text" id="substitut_plumcivil" size="30"></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top" nowrap class="Style10">Greffiers: </td>
                      <td colspan="2"><input name="greffier_plumcivil" type="text" id="greffier_plumcivil" size="30"></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top" nowrap class="Style10">Type d'affaire :</td>
                      <td colspan="2"><select name="type_affaire" id="type_affaire">
                        <option value="D&eacute;lib&eacute;r&eacute;e">D&eacute;lib&eacute;r&eacute;e</option>
                    ...
                    <tr>
                      ...
                      <td colspan="2"><textarea name="observ_plumcivil" cols="40" rows="7" id="observ_plumcivil"></textarea></td>
                    </tr>
                    <tr>

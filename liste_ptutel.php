...
mysql_select_db($database_jursta, $jursta);
$query_liste_plumtutel = "SELECT * FROM plum_tutelle, role_general WHERE ((role_general.no_rolegeneral=plum_tutelle.no_rolegeneral) AND (plum_tutelle.id_juridiction =".$row_select_juridic['id_juridiction'].") AND ((role_general.noordre_rolegeneral LIKE '".$_GET['wrdkey']."%') OR (role_general.demandeur_rolegeneral LIKE '".$_GET['wrdkey']."%') OR (role_general.defendeur_rolegeneral LIKE '".$_GET['wrdkey']."%'))) ORDER BY id_plumtutel DESC";

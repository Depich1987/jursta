...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO reg_mdepot (noordre_regmdepot, date_regmdepot, nom_regmdepot, magistra_regmdepot, infraction_regmdepot, Id_admin, date_creation, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['noordre_regmdepot'], "int"),
                       GetSQLValueString(changedatefrus($_POST['date_regmdepot']), "date"),
                       GetSQLValueString($_POST['nom_regmdepot'], "text"),
                       GetSQLValueString($_POST['magistra_regmdepot'], "text"),
                       GetSQLValueString($_POST['infraction_regmdepot'], "text"),
...
rechargerpage("liste_regmdepo.php");
</script>
<?php
}
?>
          ...
          <td width="100%" valign="middle" >
            <table width="100%" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="100%" class="Style2"><p>Le registre des Mandats de D&eacute;p&ocirc;ts  - Ajouter un enregistrement</p></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
              <tr>
                ...
                <td><input name="noordre_regmdepot" type="text" id="noordre_regmdepot" size="15" value=""></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"><span class="Style10">Date</span> :</td>
                <td><input name="date_regmdepot" type="text" id="date_regmdepot" size="15" value="<?php echo date("d-m-Y"); ?>"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"><span class="Style10">Nom et pr&eacute;noms</span> : </td>
                <td><input name="nom_regmdepot" type="text" id="nom_regmdepot2" value="" size="38"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"> <span class="Style10">Nom du Magistrat</span> : </td>
                <td><input name="magistra_regmdepot" type="text" id="magistra_regmdepot2" value="" size="38"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"> <span class="Style10">Infraction</span> :</td>
                <td><textarea name="infraction_regmdepot" cols="35" rows="4" id="infraction_regmdepot2"></textarea></td>
              </tr>
              <tr>

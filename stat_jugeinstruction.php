                ...
                <table width="100%" >
                  <tr>
                    ...
                    <td width="100%"><span class="Style2">FICHE STATISTIQUE DES ACTIVITES DU JUGE D'INSTRUCTION PERIODE DE
                      <?php echo("P&eacute;riode du ".$_SESSION['datedebut']." au ".$_SESSION['datefin']); ?> </span> </td>
                  </tr>
              </table></td>
            </tr>
            <tr>
...
<tr align="center" bgcolor="#677787" class="Style11">
                  ...
                  <form action="imprimestat_penales_activitejuge.php" method="post" name="form2" id="form2">

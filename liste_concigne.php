...
mysql_select_db($database_jursta, $jursta);
$query_liste_regconsign = "SELECT * FROM reg_consignations, role_general WHERE ((reg_consignations.no_rolegeneral=role_general.no_rolegeneral) AND (reg_consignations.id_juridiction =".$row_select_juridic['id_juridiction'].") AND ((reg_consignations.noordre_regconsign LIKE '".$_GET['wrdkey']."%') OR (role_general.demandeur_rolegeneral LIKE '".$_GET['wrdkey']."%') OR (role_general.defendeur_rolegeneral LIKE '".$_GET['wrdkey']."%'))) ORDER BY reg_consignations.date_creation DESC";

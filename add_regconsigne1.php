...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO reg_consignations (no_regconsign, noordre_regconsign, date_regconsign, no_rolegeneral, demandeur_regconsign, defendeur_regconsign, montant_regconsign, decision_regconsign, somareclam_regconsign, somarestit_regconsign, liquidation_regconsign, observation_regconsign, Id_admin, date_creation, id_juridiction) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['noordre_regconsign'], "int"),
                       GetSQLValueString($_POST['noordre_regconsign'], "text"),
                       GetSQLValueString($_POST['date_regconsign'], "date"),
                       GetSQLValueString($_POST['no_rolegeneral'], "text"),
                       GetSQLValueString($_POST['demandeur_regconsign'], "text"),
                       GetSQLValueString($_POST['defendeur_regconsign'], "text"),
...
rechargerpage("liste_regconsigne.php");
</script>
<?php
}
?>
        ...
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="0">
              ...
              <tr>
                ...
                <td><input name="date_regconsign" type="text" id="date_regconsign" size="15"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"><span class="Style10">N&deg; R&ocirc;le g&eacute;n&eacute;rale : </span></td>
                <td><input name="no_rolegeneral" type="text" size="15"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Demandeur</td>
                <td><input name="demandeur_regconsign" type="text" id="demandeur_regconsign" size="35"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Defendeur</td>
                <td><input name="defendeur_regconsign" type="text" id="defendeur_regconsign" size="35"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"><span class="Style10">Montant</span> : </td>
                <td><input name="montant_regconsign" type="text" id="montant_regconsign" size="40"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"> <span class="Style10">Decision</span> : </td>
                <td><input name="decision_regconsign" type="text" id="decision_regconsign" size="15"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"><span class="Style10">Somme &agrave; r&eacute;clamer</span> : </td>
                <td><input name="somareclam_regconsign" type="text" id="somareclam_regconsign" size="25"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"><span class="Style10">Somme &agrave; restituer</span> : </td>
                <td><input name="somarestit_regconsign" type="text" id="somarestit_regconsign" size="25"></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10"><span class="Style10">Liquidation :</span></td>
                <td><textarea name="liquidation_regconsign" cols="35" rows="2" id="liquidation_regconsign"></textarea></td>
              </tr>
              <tr>
                <td align="right" valign="top" nowrap class="Style10">Observation : </td>
                <td><textarea name="observation_regconsign" cols="40" rows="7" id="observation_regconsign"></textarea></td>
              </tr>
              <tr>

        ...
        <tr>
          <td valign="middle"><table width="100%" border="0" cellpadding="5" cellspacing="2">
              <tr bgcolor="#FFFFFF">
                ...
                <td class="Style10"><?php echo $row_select_rolegeneral['no_rolegeneral']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
              ...
              <tr bgcolor="#FFFFFF">
                ...
                <td class="Style10"><?php echo $row_select_rolegeneral['date_rolegeneral']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
              ...
              <tr bgcolor="#FFFFFF">
                ...
                <td class="Style10"><?php echo $row_select_rolegeneral['dateaudience_rolegeneral']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
              ...
              <tr bgcolor="#FFFFFF">
                ...
                <td class="Style10"><?php echo $row_select_rolegeneral['date_creation']; ?></td>
              </tr>
              <tr bgcolor="#FFFFFF">
